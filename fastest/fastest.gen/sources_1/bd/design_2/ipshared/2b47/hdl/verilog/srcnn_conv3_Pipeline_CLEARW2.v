...
assign add_ln74_fu_100_p2 = (ap_sig_allocacmp_w + 8'd1);
...
assign empty_fu_106_p1 = ap_sig_allocacmp_w[6:0];

assign icmp_ln74_fu_94_p2 = ((ap_sig_allocacmp_w == 8'd255) ? 1'b1 : 1'b0);

assign tmp_84_fu_110_p3 = {{add_ln72}, {empty_fu_106_p1}};

assign tmp_fu_124_p3 = ap_sig_allocacmp_w[32'd7];

assign zext_ln76_fu_118_p1 = tmp_84_fu_110_p3;
