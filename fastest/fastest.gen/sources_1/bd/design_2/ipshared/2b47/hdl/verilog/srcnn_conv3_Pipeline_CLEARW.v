...
module srcnn_conv3_Pipeline_CLEARW (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln74_fu_94_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln76_fu_118_p1;
reg   [7:0] w_fu_48;
wire   [7:0] add_ln74_fu_100_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_w_2;
wire   [0:0] tmp_fu_124_p3;
wire   [6:0] empty_fu_106_p1;
wire   [9:0] tmp_78_fu_110_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln74_fu_94_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln74_fu_94_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_124_p3 == 1'd0) & (icmp_ln74_fu_94_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_124_p3 == 1'd1) & (icmp_ln74_fu_94_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln74_fu_100_p2 = (ap_sig_allocacmp_w_2 + 8'd1);
...
assign conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_1_address0 = zext_ln76_fu_118_p1;

assign conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_1_d0 = 32'd0;

assign conv3_mulmulmulmulap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_address0 = zext_ln76_fu_118_p1;

assign conv3_mulmulmulmulap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_d0 = 32'd0;

assign empty_fu_106_p1 = ap_sig_allocacmp_w_2[6:0];

assign icmp_ln74_fu_94_p2 = ((ap_sig_allocacmp_w_2 == 8'd255) ? 1'b1 : 1'b0);

assign tmp_78_fu_110_p3 = {{h_1}, {empty_fu_106_p1}};

assign tmp_fu_124_p3 = ap_sig_allocacmp_w_2[32'd7];

assign zext_ln76_fu_118_p1 = tmp_78_fu_110_p3;

endmodule //srcnn_conv3_Pipeline_CLEARW
