...
reg   [31:0] weights_addr_read_reg_246;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] p_cast14_fu_195_p1;
reg   [6:0] loop_index_i_fu_64;
wire   [6:0] empty_221_fu_200_p2;
wire    ap_loop_init;
reg   [2:0] bout_fu_68;
wire   [2:0] select_ln91_1_fu_171_p3;
reg   [8:0] indvar_flatten_fu_72;
wire   [8:0] add_ln91_2_fu_128_p2;
reg   [8:0] ap_sig_allocacmp_indvar_flatten_load;
wire   [0:0] exitcond41049_fu_157_p2;
wire   [2:0] add_ln91_fu_151_p2;
wire   [6:0] select_ln91_fu_163_p3;
wire   [1:0] empty_220_fu_183_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln91_fu_122_p2 == 1'd0))) begin
            indvar_flatten_fu_72 <= add_ln91_2_fu_128_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            loop_index_i_fu_64 <= 7'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            loop_index_i_fu_64 <= empty_221_fu_200_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln91_reg_242 <= icmp_ln91_fu_122_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln91_reg_242 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        weights_addr_read_reg_246 <= m_axi_weights_RDATA;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln91_fu_122_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln91_reg_242 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln91_reg_242 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln91_reg_242 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln91_2_fu_128_p2 = (ap_sig_allocacmp_indvar_flatten_load + 9'd1);

assign add_ln91_fu_151_p2 = (bout_fu_68 + 3'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln91_reg_242 == 1'd0) & (m_axi_weights_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln91_reg_242 == 1'd0) & (m_axi_weights_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln91_reg_242 == 1'd0) & (m_axi_weights_RVALID == 1'b0));
end
...
assign empty_220_fu_183_p1 = select_ln91_1_fu_171_p3[1:0];

assign empty_221_fu_200_p2 = (select_ln91_fu_163_p3 + 7'd1);

assign empty_fu_179_p1 = select_ln91_fu_163_p3[5:0];

assign exitcond41049_fu_157_p2 = ((loop_index_i_fu_64 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln91_fu_122_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd256) ? 1'b1 : 1'b0);
...
assign p_cast14_fu_195_p1 = tmp_s_fu_187_p3;

assign select_ln91_1_fu_171_p3 = ((exitcond41049_fu_157_p2[0:0] == 1'b1) ? add_ln91_fu_151_p2 : bout_fu_68);

assign select_ln91_fu_163_p3 = ((exitcond41049_fu_157_p2[0:0] == 1'b1) ? 7'd0 : loop_index_i_fu_64);

assign tmp_s_fu_187_p3 = {{empty_220_fu_183_p1}, {empty_fu_179_p1}};

assign weight_buffer_address0 = p_cast14_fu_195_p1;

assign weight_buffer_d0 = weights_addr_read_reg_246;
