...
reg   [7:0] phi_urem1067_fu_102;
wire   [7:0] idx_urem1069_fu_442_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul1065_fu_106;
wire   [16:0] next_mul1066_fu_372_p2;
reg   [16:0] ap_sig_allocacmp_phi_mul1065_load;
reg   [7:0] loop_index_0_i_fu_110;
wire   [7:0] empty_fu_363_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_0_i_load;
wire   [4:0] tmp_fu_378_p4;
wire   [7:0] tmp_156_fu_388_p1;
wire   [7:0] empty_226_fu_392_p2;
wire   [7:0] next_urem1068_fu_430_p2;
wire   [0:0] empty_225_fu_436_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_phi_mul1065_load = 17'd0;
    end else begin
...
assign empty_225_fu_436_p2 = ((next_urem1068_fu_430_p2 < 8'd15) ? 1'b1 : 1'b0);

assign empty_226_fu_392_p2 = (add_ln113_3 + tmp_156_fu_388_p1);
...
assign idx_urem1069_fu_442_p3 = ((empty_225_fu_436_p2[0:0] == 1'b1) ? next_urem1068_fu_430_p2 : 8'd0);
...
assign next_mul1066_fu_372_p2 = (ap_sig_allocacmp_phi_mul1065_load + 17'd274);

assign next_urem1068_fu_430_p2 = (phi_urem1067_fu_102 + 8'd1);
...
assign p_cast_fu_398_p1 = empty_226_fu_392_p2;

assign tmp_156_fu_388_p1 = tmp_fu_378_p4;

assign tmp_52_fu_454_p16 = phi_urem1067_fu_102[3:0];

assign tmp_fu_378_p4 = {{ap_sig_allocacmp_phi_mul1065_load[16:12]}};
