...
wire   [0:0] exitcond4513_fu_343_p2;
...
reg   [0:0] exitcond4513_reg_504;
wire   [31:0] tmp_95_fu_437_p17;
reg   [31:0] tmp_95_reg_588;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] p_cast_fu_384_p1;
wire    ap_block_pp0_stage0_01001;
reg   [7:0] phi_urem4912_fu_94;
wire   [7:0] idx_urem4914_fu_370_p3;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_phi_urem4912_load;
reg   [16:0] phi_mul4910_fu_98;
wire   [16:0] next_mul4911_fu_421_p2;
reg   [7:0] loop_index_1_i_fu_102;
wire   [7:0] empty_fu_349_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_1_i_load;
wire   [7:0] next_urem4913_fu_358_p2;
wire   [0:0] empty_231_fu_364_p2;
wire   [7:0] empty_232_fu_378_p2;
wire   [3:0] tmp_95_fu_437_p16;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond4513_fu_343_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_1_i_fu_102 <= empty_fu_349_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_1_i_fu_102 <= 8'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_mul4910_fu_98 <= 17'd0;
        end else if (((ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond4513_reg_504 == 1'd0))) begin
            phi_mul4910_fu_98 <= next_mul4911_fu_421_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond4513_fu_343_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            phi_urem4912_fu_94 <= idx_urem4914_fu_370_p3;
        end else if ((ap_loop_init == 1'b1)) begin
            phi_urem4912_fu_94 <= 8'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond4513_reg_504 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_95_reg_588 <= tmp_95_fu_437_p17;
    end
end

always @ (*) begin
    if (((exitcond4513_fu_343_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond4513_reg_504 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_phi_urem4912_load = phi_urem4912_fu_94;
    end
end
...
assign empty_231_fu_364_p2 = ((next_urem4913_fu_358_p2 < 8'd17) ? 1'b1 : 1'b0);

assign empty_232_fu_378_p2 = (add_ln111_6 + ap_sig_allocacmp_phi_urem4912_load);

assign empty_fu_349_p2 = (ap_sig_allocacmp_loop_index_1_i_load + 8'd1);

assign exitcond4513_fu_343_p2 = ((ap_sig_allocacmp_loop_index_1_i_load == 8'd255) ? 1'b1 : 1'b0);

assign idx_urem4914_fu_370_p3 = ((empty_231_fu_364_p2[0:0] == 1'b1) ? next_urem4913_fu_358_p2 : 8'd0);
...
assign m_axi_i3_WDATA = tmp_95_reg_588;
...
assign next_mul4911_fu_421_p2 = (phi_mul4910_fu_98 + 17'd482);

assign next_urem4913_fu_358_p2 = (ap_sig_allocacmp_phi_urem4912_load + 8'd1);

assign p_ZZ5conv2PA255_A255_8ap_fixedILi16ELi3EL9ap_q_mode5EL9ap_o_mode3ELi0EEPA64_A1_A1_1_address0 = p_cast_fu_384_p1;

assign p_ZZ5conv2PA255_A255_8ap_fixedILi16ELi3EL9ap_q_mode5EL9ap_o_mode3ELi0EEPA64_A1_A1_2_address0 = p_cast_fu_384_p1;

assign p_ZZ5conv2PA255_A255_8ap_fixedILi16ELi3EL9ap_q_mode5EL9ap_o_mode3ELi0EEPA64_A1_A1_3_address0 = p_cast_fu_384_p1;

assign p_ZZ5conv2PA255_A255_8ap_fixedILi16ELi3EL9ap_q_mode5EL9ap_o_mode3ELi0EEPA64_A1_A1_4_address0 = p_cast_fu_384_p1;

assign p_ZZ5conv2PA255_A255_8ap_fixedILi16ELi3EL9ap_q_mode5EL9ap_o_mode3ELi0EEPA64_A1_A1_address0 = p_cast_fu_384_p1;

assign p_cast_fu_384_p1 = empty_232_fu_378_p2;

assign tmp_95_fu_437_p16 = {{phi_mul4910_fu_98[16:13]}};
