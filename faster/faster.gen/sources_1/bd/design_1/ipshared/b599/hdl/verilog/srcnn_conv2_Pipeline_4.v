...
reg   [7:0] phi_urem4902_fu_94;
wire   [7:0] idx_urem4904_fu_370_p3;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_phi_urem4902_load;
reg   [16:0] phi_mul4900_fu_98;
wire   [16:0] next_mul4901_fu_421_p2;
reg   [7:0] loop_index_0_i_fu_102;
wire   [7:0] empty_fu_349_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_0_i_load;
wire   [7:0] next_urem4903_fu_358_p2;
wire   [0:0] empty_233_fu_364_p2;
wire   [7:0] empty_234_fu_378_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond4111_fu_343_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            phi_urem4902_fu_94 <= idx_urem4904_fu_370_p3;
        end else if ((ap_loop_init == 1'b1)) begin
            phi_urem4902_fu_94 <= 8'd0;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_phi_urem4902_load = phi_urem4902_fu_94;
    end
end
...
assign empty_233_fu_364_p2 = ((next_urem4903_fu_358_p2 < 8'd17) ? 1'b1 : 1'b0);

assign empty_234_fu_378_p2 = (add_ln111_3 + ap_sig_allocacmp_phi_urem4902_load);
...
assign idx_urem4904_fu_370_p3 = ((empty_233_fu_364_p2[0:0] == 1'b1) ? next_urem4903_fu_358_p2 : 8'd0);
...
assign next_mul4901_fu_421_p2 = (phi_mul4900_fu_98 + 17'd482);

assign next_urem4903_fu_358_p2 = (ap_sig_allocacmp_phi_urem4902_load + 8'd1);
...
assign p_cast_fu_384_p1 = empty_234_fu_378_p2;

assign tmp_93_fu_437_p16 = {{phi_mul4900_fu_98[16:13]}};
