...
reg    ap_ready_int;
wire   [63:0] zext_ln74_fu_112_p1;
reg   [7:0] w_fu_42;
wire   [7:0] add_ln72_fu_94_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_w_5;
wire   [0:0] tmp_fu_118_p3;
wire   [6:0] empty_fu_100_p1;
wire   [13:0] tmp_330_fu_104_p3;
reg    ap_done_reg;
...
always @ (*) begin
    if (((icmp_ln72_fu_88_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_118_p3 == 1'd0) & (icmp_ln72_fu_88_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_118_p3 == 1'd1) & (icmp_ln72_fu_88_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln72_fu_94_p2 = (ap_sig_allocacmp_w_5 + 8'd1);
...
assign conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_1_address0 = zext_ln74_fu_112_p1;

assign conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_1_d0 = 16'd0;

assign conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_address0 = zext_ln74_fu_112_p1;

assign conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_d0 = 16'd0;

assign empty_fu_100_p1 = ap_sig_allocacmp_w_5[6:0];

assign icmp_ln72_fu_88_p2 = ((ap_sig_allocacmp_w_5 == 8'd255) ? 1'b1 : 1'b0);

assign tmp_330_fu_104_p3 = {{tmp_326}, {empty_fu_100_p1}};

assign tmp_fu_118_p3 = ap_sig_allocacmp_w_5[32'd7];

assign zext_ln74_fu_112_p1 = tmp_330_fu_104_p3;
