...
reg   [7:0] phi_urem4927_fu_100;
wire   [7:0] select_ln61_fu_419_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul4925_fu_104;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_urem4927_fu_100 <= 8'd0;
        end else if (((icmp_ln61_fu_346_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            phi_urem4927_fu_100 <= select_ln61_fu_419_p3;
        end
    end
end
...
assign add_ln61_1_fu_388_p2 = (phi_mul4925_fu_104 + 17'd482);

assign add_ln61_2_fu_407_p2 = (phi_urem4927_fu_100 + 8'd1);

assign add_ln61_fu_352_p2 = (w_fu_108 + 8'd1);

assign add_ln63_fu_364_p2 = (add_ln63_1 + phi_urem4927_fu_100);
...
assign trunc_ln61_2_fu_394_p4 = {{phi_mul4925_fu_104[16:13]}};
