<project xmlns="com.autoesl.autopilot.project" name="srcnn_hls" top="srcnn" projectType="C/C++">
    ...
    <files xmlns="">
        ...
        <file name="../../../SRCNN/test/csim.cpp" sc="0" tb="1" cflags="-Wno-unknown-pragmas" csimflags="" blackbox="false"/>
        ...
        <file name="../../test/util.h" sc="0" tb="1" cflags="-Wno-unknown-pragmas" csimflags="" blackbox="false"/>
        <file name="../../../SRCNN/test/output" sc="0" tb="1" cflags="-Wno-unknown-pragmas" csimflags="" blackbox="false"/>
