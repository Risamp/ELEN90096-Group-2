...
module srcnn_conv2_Pipeline_BW7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln65_1_fu_132_p2;
...
reg   [7:0] phi_urem534_fu_54;
wire   [7:0] select_ln65_fu_197_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul532_fu_58;
wire   [16:0] add_ln65_fu_166_p2;
reg   [7:0] w_4_fu_62;
wire   [7:0] add_ln65_1_fu_138_p2;
wire   [1:0] trunc_ln65_1_fu_172_p4;
wire   [9:0] zext_ln67_fu_150_p1;
wire   [9:0] add_ln67_1_fu_154_p2;
wire   [7:0] add_ln65_3_fu_185_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_urem534_fu_54 <= 8'd0;
        end else if (((icmp_ln65_1_fu_132_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            phi_urem534_fu_54 <= select_ln65_fu_197_p3;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln65_1_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln65_1_fu_132_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln65_1_fu_172_p4 == 2'd1))) begin
...
always @ (*) begin
    if (((icmp_ln65_1_fu_132_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (trunc_ln65_1_fu_172_p4 == 2'd0))) begin
...
always @ (*) begin
    if ((~(trunc_ln65_1_fu_172_p4 == 2'd0) & ~(trunc_ln65_1_fu_172_p4 == 2'd1) & (icmp_ln65_1_fu_132_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln65_3_fu_185_p2 = (phi_urem534_fu_54 + 8'd1);

assign add_ln65_fu_166_p2 = (phi_mul532_fu_58 + 17'd386);
...
assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_1_address0 = zext_ln67_2_fu_159_p1;

assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_1_d0 = 32'd0;

assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_2_address0 = zext_ln67_2_fu_159_p1;

assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_2_d0 = 32'd0;

assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_address0 = zext_ln67_2_fu_159_p1;

assign conv2_float_255_255_float_64_1_1_float_float_255_255_o_d0 = 32'd0;

assign icmp_ln65_1_fu_132_p2 = ((w_4_fu_62 == 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln65_fu_191_p2 = ((add_ln65_3_fu_185_p2 < 8'd85) ? 1'b1 : 1'b0);

assign select_ln65_fu_197_p3 = ((icmp_ln65_fu_191_p2[0:0] == 1'b1) ? add_ln65_3_fu_185_p2 : 8'd0);

assign trunc_ln65_1_fu_172_p4 = {{phi_mul532_fu_58[16:15]}};

assign zext_ln67_2_fu_159_p1 = add_ln67_1_fu_154_p2;

assign zext_ln67_fu_150_p1 = phi_urem534_fu_54;
