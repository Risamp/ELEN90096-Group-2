...
reg    ap_ready_int;
wire   [63:0] zext_ln63_1_fu_86_p1;
reg   [7:0] w_fu_32;
...
assign add_ln61_fu_70_p2 = (ap_sig_allocacmp_w_3 + 8'd1);

assign add_ln63_fu_80_p2 = (add_ln63_1 + zext_ln63_fu_76_p1);
...
assign icmp_ln61_fu_64_p2 = ((ap_sig_allocacmp_w_3 == 8'd255) ? 1'b1 : 1'b0);

assign output_fm_buffer_address0 = zext_ln63_1_fu_86_p1;

assign output_fm_buffer_d0 = 32'd0;

assign zext_ln63_1_fu_86_p1 = add_ln63_fu_80_p2;

assign zext_ln63_fu_76_p1 = ap_sig_allocacmp_w_3;
