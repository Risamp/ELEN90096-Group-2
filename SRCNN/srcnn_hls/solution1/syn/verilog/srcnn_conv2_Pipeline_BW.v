...
reg   [7:0] phi_urem442_fu_54;
wire   [7:0] select_ln65_fu_197_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul440_fu_58;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_urem442_fu_54 <= 8'd0;
        end else if (((icmp_ln65_fu_132_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            phi_urem442_fu_54 <= select_ln65_fu_197_p3;
        end
    end
end
...
assign add_ln65_4_fu_166_p2 = (phi_mul440_fu_58 + 17'd386);

assign add_ln65_5_fu_185_p2 = (phi_urem442_fu_54 + 8'd1);
...
assign trunc_ln_fu_172_p4 = {{phi_mul440_fu_58[16:15]}};

assign zext_ln67_3_fu_159_p1 = add_ln67_fu_154_p2;

assign zext_ln67_fu_150_p1 = phi_urem442_fu_54;
