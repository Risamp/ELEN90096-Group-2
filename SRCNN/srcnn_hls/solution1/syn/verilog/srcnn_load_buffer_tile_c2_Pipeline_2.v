...
module srcnn_load_buffer_tile_c2_Pipeline_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond13811_fu_58_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] p_cast23_fu_80_p1;
reg   [8:0] empty_fu_32;
wire   [8:0] empty_83_fu_64_p2;
wire    ap_loop_init;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond13811_fu_58_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond13811_fu_58_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign empty_83_fu_64_p2 = (ap_sig_allocacmp_p_load + 9'd1);

assign exitcond13811_fu_58_p2 = ((ap_sig_allocacmp_p_load == 9'd256) ? 1'b1 : 1'b0);

assign p_cast23_fu_80_p1 = tmp_fu_70_p4;

assign tmp_fu_70_p4 = {{ap_sig_allocacmp_p_load[7:3]}};

assign weights_buffer_0_0_0_address0 = p_cast23_fu_80_p1;

assign weights_buffer_0_0_0_d0 = 32'd0;

endmodule //srcnn_load_buffer_tile_c2_Pipeline_2
