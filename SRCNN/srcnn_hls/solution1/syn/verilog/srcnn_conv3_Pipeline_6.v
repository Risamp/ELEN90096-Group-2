...
wire   [0:0] exitcond8519_fu_126_p2;
...
reg   [0:0] exitcond8519_reg_199;
reg   [0:0] tmp_reg_213;
wire   [31:0] tmp_28_fu_174_p4;
reg   [31:0] tmp_28_reg_223;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] tmp_55_cast_fu_150_p1;
wire    ap_block_pp0_stage0_01001;
reg   [7:0] loop_index_1_i_fu_64;
wire   [7:0] empty_fu_132_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_loop_index_1_i_load;
wire   [6:0] empty_71_fu_138_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond8519_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_1_i_fu_64 <= empty_fu_132_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_1_i_fu_64 <= 8'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond8519_reg_199 == 1'd0))) begin
        tmp_28_reg_223 <= tmp_28_fu_174_p4;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond8519_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_213 <= ap_sig_allocacmp_loop_index_1_i_load[32'd7];
    end
end

always @ (*) begin
    if (((exitcond8519_fu_126_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond8519_reg_199 == 1'd1))) begin
...
assign conv3_float_255_255_float_32_5_5_float_float_255_255_o_1_address0 = tmp_55_cast_fu_150_p1;

assign conv3_float_255_255_float_32_5_5_float_float_255_255_o_address0 = tmp_55_cast_fu_150_p1;

assign empty_71_fu_138_p1 = ap_sig_allocacmp_loop_index_1_i_load[6:0];

assign empty_fu_132_p2 = (ap_sig_allocacmp_loop_index_1_i_load + 8'd1);

assign exitcond8519_fu_126_p2 = ((ap_sig_allocacmp_loop_index_1_i_load == 8'd255) ? 1'b1 : 1'b0);
...
assign m_axi_o_WDATA = tmp_28_reg_223;
...
assign tmp_55_cast_fu_150_p1 = tmp_s_fu_142_p3;

assign tmp_s_fu_142_p3 = {{or_ln126}, {empty_71_fu_138_p1}};
