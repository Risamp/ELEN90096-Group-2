...
module srcnn_conv3_Pipeline_CLEARW5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign icmp_ln72_fu_58_p2 = ((ap_sig_allocacmp_w_3 == 8'd255) ? 1'b1 : 1'b0);

assign output_fm_buffer_0_address0 = zext_ln74_1_fu_80_p1;

assign output_fm_buffer_0_d0 = 32'd0;

assign zext_ln74_1_fu_80_p1 = add_ln74_fu_74_p2;

assign zext_ln74_fu_70_p1 = ap_sig_allocacmp_w_3;

endmodule //srcnn_conv3_Pipeline_CLEARW5
