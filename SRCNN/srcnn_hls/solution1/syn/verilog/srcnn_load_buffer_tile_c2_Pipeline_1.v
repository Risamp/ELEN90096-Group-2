...
module srcnn_load_buffer_tile_c2_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond13912_fu_52_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] p_cast_fu_64_p1;
reg   [11:0] empty_fu_26;
wire   [11:0] empty_74_fu_58_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((exitcond13912_fu_52_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond13912_fu_52_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (exitcond13912_fu_52_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign empty_74_fu_58_p2 = (ap_sig_allocacmp_p_load + 12'd1);

assign exitcond13912_fu_52_p2 = ((ap_sig_allocacmp_p_load == 12'd2312) ? 1'b1 : 1'b0);
...
endmodule //srcnn_load_buffer_tile_c2_Pipeline_1
