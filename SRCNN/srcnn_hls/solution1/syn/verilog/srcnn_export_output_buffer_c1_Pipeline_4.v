...
wire   [0:0] exitcond3810_fu_103_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond3810_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_1_fu_54 <= empty_fu_109_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_1_fu_54 <= 8'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3810_reg_156 == 1'd0))) begin
        output_fm_buffer_1_load_reg_170 <= output_fm_buffer_1_q0;
    end
end

always @ (*) begin
    if (((exitcond3810_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3810_reg_156 == 1'd1))) begin
...
assign empty_40_fu_119_p2 = (sub_ln140_2 + loop_index_1_cast1_fu_115_p1);

assign empty_fu_109_p2 = (ap_sig_allocacmp_loop_index_1_load + 8'd1);

assign exitcond3810_fu_103_p2 = ((ap_sig_allocacmp_loop_index_1_load == 8'd255) ? 1'b1 : 1'b0);

assign loop_index_1_cast1_fu_115_p1 = ap_sig_allocacmp_loop_index_1_load;
...
assign p_cast_fu_125_p1 = empty_40_fu_119_p2;
