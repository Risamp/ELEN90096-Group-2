...
module srcnn_export_output_buffer_c1_Pipeline_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond3412_fu_126_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond3412_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3412_reg_199 == 1'd0))) begin
        tmp_3_reg_223 <= tmp_3_fu_174_p4;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3412_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_213 <= ap_sig_allocacmp_loop_index_1_load[32'd7];
    end
end

always @ (*) begin
    if (((exitcond3412_fu_126_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3412_reg_199 == 1'd1))) begin
...
assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_1_address0 = tmp_19_cast_fu_150_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_address0 = tmp_19_cast_fu_150_p1;

assign empty_312_fu_138_p1 = ap_sig_allocacmp_loop_index_1_load[6:0];

assign empty_fu_132_p2 = (ap_sig_allocacmp_loop_index_1_load + 8'd1);

assign exitcond3412_fu_126_p2 = ((ap_sig_allocacmp_loop_index_1_load == 8'd255) ? 1'b1 : 1'b0);
...
assign m_axi_bundle_2_WDATA = tmp_3_reg_223;
...
assign tmp_s_fu_142_p3 = {{tmp_15}, {empty_312_fu_138_p1}};
