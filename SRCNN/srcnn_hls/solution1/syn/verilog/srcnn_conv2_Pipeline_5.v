...
wire   [0:0] exitcond5215_fu_351_p2;
...
reg   [7:0] phi_urem4778_fu_102;
wire   [7:0] idx_urem4780_fu_378_p3;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_phi_urem4778_load;
reg   [16:0] phi_mul4776_fu_106;
wire   [16:0] next_mul4777_fu_429_p2;
reg   [7:0] loop_index_1_i_fu_110;
wire   [7:0] empty_fu_357_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_1_i_load;
wire   [7:0] next_urem4779_fu_366_p2;
wire   [0:0] empty_481_fu_372_p2;
wire   [7:0] empty_482_fu_386_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond5215_fu_351_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_mul4776_fu_106 <= 17'd0;
        end else if (((ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond5215_reg_516 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond5215_reg_516 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_s_reg_600 <= tmp_s_fu_445_p17;
    end
end

always @ (*) begin
    if (((exitcond5215_fu_351_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond5215_reg_516 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_phi_urem4778_load = 8'd0;
    end else begin
...
assign empty_481_fu_372_p2 = ((next_urem4779_fu_366_p2 < 8'd17) ? 1'b1 : 1'b0);

assign empty_482_fu_386_p2 = (add_ln112_4 + ap_sig_allocacmp_phi_urem4778_load);

assign empty_fu_357_p2 = (ap_sig_allocacmp_loop_index_1_i_load + 8'd1);

assign exitcond5215_fu_351_p2 = ((ap_sig_allocacmp_loop_index_1_i_load == 8'd255) ? 1'b1 : 1'b0);

assign idx_urem4780_fu_378_p3 = ((empty_481_fu_372_p2[0:0] == 1'b1) ? next_urem4779_fu_366_p2 : 8'd0);
...
assign next_mul4777_fu_429_p2 = (phi_mul4776_fu_106 + 17'd482);

assign next_urem4779_fu_366_p2 = (ap_sig_allocacmp_phi_urem4778_load + 8'd1);
...
assign p_cast_fu_392_p1 = empty_482_fu_386_p2;

assign tmp_s_fu_445_p16 = {{phi_mul4776_fu_106[16:13]}};
