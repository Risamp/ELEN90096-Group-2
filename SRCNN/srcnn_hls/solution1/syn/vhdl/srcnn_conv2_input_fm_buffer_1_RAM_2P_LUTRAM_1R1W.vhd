...
entity srcnn_conv2_input_fm_buffer_1_RAM_2P_LUTRAM_1R1W is 
    generic(
        MEM_TYPE        : string    := "distributed"; 
        DataWidth       : integer   := 32; 
        AddressWidth    : integer   := 16;
        AddressRange    : integer   := 48960
    ); 
    port (
...
architecture rtl of srcnn_conv2_input_fm_buffer_1_RAM_2P_LUTRAM_1R1W is 
