...
attribute shreg_extract : string;
    ...
    signal phi_urem442_fu_54 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln65_fu_197_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal phi_mul440_fu_58 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    phi_mul440_fu_58_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul440_fu_58 <= ap_const_lv17_0;
    ...
    phi_urem442_fu_54_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_urem442_fu_54 <= ap_const_lv8_0;
                elsif (((icmp_ln65_fu_132_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    add_ln65_4_fu_166_p2 <= std_logic_vector(unsigned(phi_mul440_fu_58) + unsigned(ap_const_lv17_182));
    add_ln65_5_fu_185_p2 <= std_logic_vector(unsigned(phi_urem442_fu_54) + unsigned(ap_const_lv8_1));
    ...
    select_ln65_fu_197_p3 <= 
        ...
        ap_const_lv8_0;
    trunc_ln_fu_172_p4 <= phi_mul440_fu_58(16 downto 15);
    zext_ln67_3_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln67_fu_154_p2),64));
    zext_ln67_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(phi_urem442_fu_54),10));
end behav;
