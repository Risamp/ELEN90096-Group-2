...
attribute shreg_extract : string;
    ...
    signal zext_ln111_2_fu_117_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal bw_fu_44 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal add_ln111_2_fu_111_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln111_fu_127_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln111_fu_131_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    bw_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if ((icmp_ln108_fu_95_p2 = ap_const_lv1_0)) then 
                    bw_fu_44 <= add_ln108_fu_101_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    bw_fu_44 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln108_fu_95_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                output_fm_buffer_addr_reg_182 <= zext_ln111_2_fu_117_p1(12 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln108_fu_101_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_bw_3) + unsigned(ap_const_lv8_1));
    add_ln111_2_fu_111_p2 <= std_logic_vector(unsigned(sub_ln111_1) + unsigned(zext_ln111_fu_107_p1));
    add_ln111_fu_131_p2 <= std_logic_vector(unsigned(output_fm_buffer_q0) + unsigned(sext_ln108_cast_reg_174));
    ...
    ap_sig_allocacmp_bw_3_assign_proc : process(ap_CS_fsm_state1, bw_fu_44, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_bw_3 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_bw_3 <= bw_fu_44;
        end if; 
    end process;

    icmp_ln108_fu_95_p2 <= "1" when (ap_sig_allocacmp_bw_3 = ap_const_lv8_FF) else "0";

    output_fm_buffer_address0_assign_proc : process(ap_CS_fsm_state1, icmp_ln108_fu_95_p2, ap_CS_fsm_state2, output_fm_buffer_addr_reg_182, zext_ln111_2_fu_117_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            ...
            output_fm_buffer_address0 <= zext_ln111_2_fu_117_p1(12 - 1 downto 0);
        else 
    ...
    tmp_fu_141_p3 <= add_ln111_fu_131_p2(31 downto 31);
    trunc_ln111_fu_127_p1 <= output_fm_buffer_q0(31 - 1 downto 0);
    zext_ln111_2_fu_117_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln111_2_fu_111_p2),64));
    zext_ln111_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_bw_3),12));
end behav;
