...
define void @apatb_srcnn_ir([255 x [255 x float]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %input_ftmap, [1 x [9 x [9 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "maxi" %conv1_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %conv1_biases, [255 x [255 x float]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" "maxi" %conv1_output_ftmap, [64 x [1 x [1 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" "maxi" %conv2_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" %conv2_biases, [255 x [255 x float]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="32" "maxi" %conv2_output_ftmap, [32 x [5 x [5 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %conv3_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" %conv3_biases, [255 x [255 x float]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="1" "maxi" %output_ftmap) local_unnamed_addr #0 {
entry:
