...
config_export -format ip_catalog -output C:/SPB_Data/ELEN90096-Group-2 -rtl verilog
source "./srcnn_hls/solution1/directives.tcl"
csim_design -clean
csynth_design
cosim_design
export_design -rtl verilog -format ip_catalog -output C:/SPB_Data/ELEN90096-Group-2
