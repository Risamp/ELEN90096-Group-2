...
entity srcnn_conv2_Pipeline_RELU7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of srcnn_conv2_Pipeline_RELU7 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_3_fu_127_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln108_fu_92_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                output_fm_buffer_addr_reg_189 <= zext_ln111_1_fu_114_p1(12 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    grp_fu_1002_p_din0 <= add15_1_i_reg_199;
    ...
    icmp_ln113_fu_141_p2 <= "0" when (tmp_3_fu_127_p4 = ap_const_lv8_FF) else "1";
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            ...
            output_fm_buffer_address0 <= zext_ln111_1_fu_114_p1(12 - 1 downto 0);
        else 
    ...
    tmp_3_fu_127_p4 <= bitcast_ln113_fu_124_p1(30 downto 23);
    ...
    zext_ln111_fu_104_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_bw),12));
end behav;
