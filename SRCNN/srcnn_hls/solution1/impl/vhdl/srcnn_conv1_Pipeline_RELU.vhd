...
port (
    ...
    mul_ln140 : IN STD_LOGIC_VECTOR (13 downto 0);
...
attribute shreg_extract : string;
    ...
    signal phi_urem3186_load_reg_337 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal add_ln137_fu_176_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln137_reg_346 : STD_LOGIC_VECTOR (7 downto 0);
    signal phi_mul3184_load_reg_351 : STD_LOGIC_VECTOR (16 downto 0);
    signal conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_14_reg_356 : STD_LOGIC_VECTOR (13 downto 0);
    signal conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_15_reg_361 : STD_LOGIC_VECTOR (13 downto 0);
    signal conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_16_reg_366 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln140_3_fu_204_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal phi_urem3186_fu_72 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln137_fu_279_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal phi_mul3184_fu_76 : STD_LOGIC_VECTOR (16 downto 0);
    signal add_ln137_3_fu_211_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal bw_fu_80 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln137_fu_216_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln140_1_fu_261_p1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal tmp_113_fu_245_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln140_1_fu_240_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal value_2_fu_253_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln137_4_fu_268_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln137_2_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    mux_3_2_16_1_1_U38 : component srcnn_mux_3_2_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    bw_fu_80 <= add_ln137_reg_346;
                end if;
            end if; 
        end if;
    end process;

    phi_mul3184_fu_76_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul3184_fu_76 <= ap_const_lv17_0;
                elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                    phi_mul3184_fu_76 <= add_ln137_3_fu_211_p2;
                end if;
            end if; 
        end if;
    end process;

    phi_urem3186_fu_72_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_urem3186_fu_72 <= ap_const_lv8_0;
                elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                    phi_urem3186_fu_72 <= select_ln137_fu_279_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                ...
                phi_urem3186_load_reg_337 <= phi_urem3186_fu_72;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln137_fu_170_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_14_reg_356 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
                conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_15_reg_361 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
                conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_16_reg_366 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
                phi_mul3184_load_reg_351 <= phi_mul3184_fu_76;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln137_3_fu_211_p2 <= std_logic_vector(unsigned(phi_mul3184_load_reg_351) + unsigned(ap_const_lv17_156));
    add_ln137_4_fu_268_p2 <= std_logic_vector(unsigned(phi_urem3186_load_reg_337) + unsigned(ap_const_lv8_1));
    add_ln137_fu_176_p2 <= std_logic_vector(unsigned(bw_fu_80) + unsigned(ap_const_lv8_1));
    add_ln140_1_fu_240_p2 <= std_logic_vector(unsigned(trunc_ln140_fu_231_p1) + unsigned(sext_ln140_cast_reg_327));
    add_ln140_fu_199_p2 <= std_logic_vector(unsigned(mul_ln140) + unsigned(zext_ln140_fu_195_p1));
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_2_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_16_reg_366, zext_ln140_3_fu_204_p1, ap_block_pp0_stage1, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_2_address0 <= conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_16_reg_366;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_2_address0 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
        else 
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_2_d0 <= zext_ln140_1_fu_261_p1;
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_3_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_15_reg_361, zext_ln140_3_fu_204_p1, ap_block_pp0_stage1, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_3_address0 <= conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_15_reg_361;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_3_address0 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
        else 
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_3_d0 <= zext_ln140_1_fu_261_p1;
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_4_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_14_reg_356, zext_ln140_3_fu_204_p1, ap_block_pp0_stage1, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_4_address0 <= conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_14_reg_356;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_4_address0 <= zext_ln140_3_fu_204_p1(14 - 1 downto 0);
        else 
    ...
    conv1_ap_fixed_255_255_ap_fixed_1_9_9_ap_fixed_ap_fixed_255_2_4_d0 <= zext_ln140_1_fu_261_p1;
    ...
    icmp_ln137_2_fu_273_p2 <= "1" when (unsigned(add_ln137_4_fu_268_p2) < unsigned(ap_const_lv8_3)) else "0";
    icmp_ln137_fu_170_p2 <= "1" when (bw_fu_80 = ap_const_lv8_FF) else "0";
    select_ln137_fu_279_p3 <= 
        add_ln137_4_fu_268_p2 when (icmp_ln137_2_fu_273_p2(0) = '1') else 
        ap_const_lv8_0;
    ...
    tmp_113_fu_245_p3 <= value_fu_235_p2(15 downto 15);
    tmp_fu_185_p4 <= phi_mul3184_fu_76(16 downto 10);
    tmp_s_fu_219_p4 <= phi_urem3186_load_reg_337(2 - 1 downto 0);
    trunc_ln137_fu_216_p1 <= phi_urem3186_load_reg_337(2 - 1 downto 0);
    trunc_ln140_fu_231_p1 <= tmp_s_fu_219_p5(15 - 1 downto 0);
    value_2_fu_253_p3 <= 
        ap_const_lv15_0 when (tmp_113_fu_245_p3(0) = '1') else 
        add_ln140_1_fu_240_p2;
    value_fu_235_p2 <= std_logic_vector(unsigned(tmp_s_fu_219_p5) + unsigned(sext_ln137_cast_reg_332));
    zext_ln140_1_fu_261_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(value_2_fu_253_p3),16));
    zext_ln140_3_fu_204_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln140_fu_199_p2),64));
