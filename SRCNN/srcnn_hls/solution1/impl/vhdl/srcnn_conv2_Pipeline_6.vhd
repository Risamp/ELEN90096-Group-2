...
attribute shreg_extract : string;
    ...
    signal phi_urem819_fu_82 : STD_LOGIC_VECTOR (7 downto 0);
    signal idx_urem821_fu_228_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_phi_urem819_load : STD_LOGIC_VECTOR (7 downto 0);
    signal phi_mul817_fu_86 : STD_LOGIC_VECTOR (16 downto 0);
    signal next_mul818_fu_273_p2 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal next_urem820_fu_216_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_253_fu_222_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal phi_urem819_cast_fu_236_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal empty_254_fu_240_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    mux_5_3_32_1_1_U498 : component srcnn_mux_5_3_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    phi_mul817_fu_86_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul817_fu_86 <= ap_const_lv17_0;
                elsif (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (exitcond3513_reg_336 = ap_const_lv1_0))) then 
                    phi_mul817_fu_86 <= next_mul818_fu_273_p2;
                end if;
            end if; 
        end if;
    end process;

    phi_urem819_fu_82_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond3513_fu_201_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    phi_urem819_fu_82 <= idx_urem821_fu_228_p3;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    phi_urem819_fu_82 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_sig_allocacmp_phi_urem819_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, phi_urem819_fu_82, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_phi_urem819_load <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_phi_urem819_load <= phi_urem819_fu_82;
        end if; 
    end process;
    ...
    empty_253_fu_222_p2 <= "1" when (unsigned(next_urem820_fu_216_p2) < unsigned(ap_const_lv8_33)) else "0";
    empty_254_fu_240_p2 <= std_logic_vector(unsigned(mul_ln113_1) + unsigned(phi_urem819_cast_fu_236_p1));
    ...
    idx_urem821_fu_228_p3 <= 
        next_urem820_fu_216_p2 when (empty_253_fu_222_p2(0) = '1') else 
        ap_const_lv8_0;
    ...
    next_mul818_fu_273_p2 <= std_logic_vector(unsigned(phi_mul817_fu_86) + unsigned(ap_const_lv17_142));
    next_urem820_fu_216_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_phi_urem819_load) + unsigned(ap_const_lv8_1));
    p_cast_fu_246_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_254_fu_240_p2),64));
    phi_urem819_cast_fu_236_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_phi_urem819_load),10));
    tmp_58_fu_289_p6 <= phi_mul817_fu_86(16 downto 14);
end behav;
