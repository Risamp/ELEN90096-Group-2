...
attribute shreg_extract : string;
    ...
    signal exitcond61711_fu_126_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal exitcond61711_reg_199 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_reg_213 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_10_fu_174_p4 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_10_reg_223 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal tmp_69_cast_fu_150_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal loop_index_0_i_fu_64 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal empty_199_fu_138_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_69_fu_142_p3 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    mux_2_1_24_1_1_U291 : component srcnn_mux_2_1_24_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 24,
    ...
    loop_index_0_i_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond61711_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_0_i_fu_64 <= empty_fu_132_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_0_i_fu_64 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                exitcond61711_reg_199 <= exitcond61711_fu_126_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond61711_reg_199 = ap_const_lv1_0))) then
                tmp_10_reg_223 <= tmp_10_fu_174_p4;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond61711_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_reg_213 <= ap_sig_allocacmp_loop_index_0_i_load(7 downto 7);
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond61711_fu_126_p2)
    begin
        if (((exitcond61711_fu_126_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, exitcond61711_reg_199)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond61711_reg_199 = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_loop_index_0_i_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, loop_index_0_i_fu_64, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index_0_i_load <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_loop_index_0_i_load <= loop_index_0_i_fu_64;
        end if; 
    end process;

    conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_1_address0 <= tmp_69_cast_fu_150_p1(10 - 1 downto 0);
    ...
    conv3_mulmulmulmulap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_address0 <= tmp_69_cast_fu_150_p1(10 - 1 downto 0);
    ...
    empty_199_fu_138_p1 <= ap_sig_allocacmp_loop_index_0_i_load(7 - 1 downto 0);
    empty_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_0_i_load) + unsigned(ap_const_lv8_1));
    exitcond61711_fu_126_p2 <= "1" when (ap_sig_allocacmp_loop_index_0_i_load = ap_const_lv8_FF) else "0";
    ...
    m_axi_o_WDATA <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_reg_223),32));
    ...
    tmp_69_cast_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_69_fu_142_p3),64));
    tmp_69_fu_142_p3 <= (bh & empty_199_fu_138_p1);
end behav;
