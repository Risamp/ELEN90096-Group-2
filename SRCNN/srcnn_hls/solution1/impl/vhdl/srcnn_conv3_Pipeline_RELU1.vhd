...
attribute shreg_extract : string;
    ...
    signal select_ln144_1_cast_fu_203_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln139_fu_138_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_s_fu_142_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1_fu_164_p4 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_2_1_32_1_1_U601 : component srcnn_mux_2_1_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    select_ln144_1_cast_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln144_fu_195_p3),32));
    select_ln144_fu_195_p3 <= 
        ap_const_lv31_0 when (tmp_3_fu_187_p3(0) = '1') else 
        add_ln144_fu_182_p2;
