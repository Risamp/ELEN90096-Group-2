...
attribute shreg_extract : string;
    ...
    signal zext_ln73_3_fu_88_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    add_ln71_fu_72_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_w_2) + unsigned(ap_const_lv8_1));
    add_ln73_fu_82_p2 <= std_logic_vector(unsigned(sub_ln73_1) + unsigned(zext_ln73_fu_78_p1));
    ...
    ap_sig_allocacmp_w_2_assign_proc : process(ap_CS_fsm_state1, w_fu_34, ap_loop_init)
    begin
    ...
    icmp_ln71_fu_66_p2 <= "1" when (ap_sig_allocacmp_w_2 = ap_const_lv8_FF) else "0";
    output_fm_buffer_1_address0 <= zext_ln73_3_fu_88_p1(15 - 1 downto 0);
    ...
    zext_ln73_3_fu_88_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln73_fu_82_p2),64));
    zext_ln73_fu_78_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_w_2),15));
end behav;
