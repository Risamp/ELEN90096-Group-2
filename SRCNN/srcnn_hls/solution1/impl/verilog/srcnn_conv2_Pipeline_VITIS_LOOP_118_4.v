...
module srcnn_conv2_Pipeline_VITIS_LOOP_118_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [5:0] nout_fu_82;
wire   [5:0] add_ln118_fu_236_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_nout_1;
wire   [4:0] trunc_ln119_fu_242_p1;
wire   [12:0] shl_ln119_1_fu_246_p3;
wire   [63:0] zext_ln119_fu_254_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((icmp_ln118_fu_230_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7) & (icmp_ln118_reg_351 == 1'd1) & (1'b0 == ap_block_pp0_stage7_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln118_reg_351_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln118_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln118_reg_351 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
assign add_ln118_fu_236_p2 = (ap_sig_allocacmp_nout_1 + 6'd1);

assign add_ln119_1_fu_264_p2 = (add_ln119_fu_258_p2 + zext_ln118_cast_fu_218_p1);

assign add_ln119_fu_258_p2 = (zext_ln119_fu_254_p1 + conv2_weights);
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = (((m_axi_gmem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_io)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((m_axi_gmem_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_io)));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage1_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state11_pp0_stage2_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state12_pp0_stage3_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state13_pp0_stage4_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state14_pp0_stage5_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state15_pp0_stage6_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state16_pp0_stage7_iter1 = (m_axi_gmem_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state17_pp0_stage0_iter2 = (m_axi_gmem_RVALID == 1'b0);
end
...
always @ (*) begin
    ap_block_state2_io = ((m_axi_gmem_ARREADY == 1'b0) & (icmp_ln118_reg_351 == 1'd0));
end
...
assign m_axi_gmem_ARADDR = gmem_addr_16_reg_355;
...
assign zext_ln118_cast_fu_218_p1 = zext_ln118;
