...
assign add_ln75_fu_94_p2 = (ap_sig_allocacmp_w + 8'd1);
...
assign empty_fu_100_p1 = ap_sig_allocacmp_w[6:0];

assign icmp_ln75_fu_88_p2 = ((ap_sig_allocacmp_w == 8'd255) ? 1'b1 : 1'b0);

assign tmp_fu_118_p3 = ap_sig_allocacmp_w[32'd7];

assign tmp_s_fu_104_p3 = {{add_ln73}, {empty_fu_100_p1}};
