...
output   ap_idle;
output   ap_ready;
input  [12:0] sub_ln82_2;
input  [1:0] trunc_ln77_mid2;
...
wire   [0:0] icmp_ln80_fu_130_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln82_1_fu_152_p1;
reg   [7:0] w_fu_50;
wire   [7:0] add_ln80_fu_136_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_w_1;
wire   [1:0] trunc_ln77_mid2_read_read_fu_54_p2;
wire   [12:0] zext_ln82_fu_142_p1;
wire   [12:0] add_ln82_fu_146_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln80_fu_130_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln80_fu_130_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln77_mid2_read_read_fu_54_p2 == 2'd2) & (icmp_ln80_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln77_mid2_read_read_fu_54_p2 == 2'd1) & (icmp_ln80_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln77_mid2_read_read_fu_54_p2 == 2'd0) & (icmp_ln80_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((trunc_ln77_mid2_read_read_fu_54_p2 == 2'd3) & (icmp_ln80_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln80_fu_136_p2 = (ap_sig_allocacmp_w_1 + 8'd1);

assign add_ln82_fu_146_p2 = (sub_ln82_2 + zext_ln82_fu_142_p1);
...
assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_1_address0 = zext_ln82_1_fu_152_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_1_d0 = 32'd0;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_2_address0 = zext_ln82_1_fu_152_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_2_d0 = 32'd0;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_3_address0 = zext_ln82_1_fu_152_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_3_d0 = 32'd0;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_address0 = zext_ln82_1_fu_152_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_d0 = 32'd0;

assign icmp_ln80_fu_130_p2 = ((ap_sig_allocacmp_w_1 == 8'd255) ? 1'b1 : 1'b0);

assign trunc_ln77_mid2_read_read_fu_54_p2 = trunc_ln77_mid2;

assign zext_ln82_1_fu_152_p1 = add_ln82_fu_146_p2;

assign zext_ln82_fu_142_p1 = ap_sig_allocacmp_w_1;
