...
output   ap_ready;
input  [2:0] or_ln139;
input  [13:0] shl_ln142_cast;
input  [13:0] sext_ln142;
...
wire  signed [14:0] sext_ln142_cast_fu_110_p1;
reg  signed [14:0] sext_ln142_cast_reg_220;
wire  signed [15:0] shl_ln142_cast_cast_fu_114_p1;
reg  signed [15:0] shl_ln142_cast_cast_reg_225;
...
reg   [9:0] conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_264_reg_243;
reg   [0:0] tmp_reg_248;
wire   [63:0] zext_ln142_fu_150_p1;
reg   [7:0] bw_fu_62;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_bw_1;
wire   [15:0] select_ln144_1_cast_fu_203_p1;
wire   [6:0] trunc_ln139_fu_138_p1;
wire   [9:0] tmp_s_fu_142_p3;
wire   [15:0] tmp_2_fu_164_p4;
wire   [14:0] trunc_ln142_fu_173_p1;
wire   [15:0] add_ln142_fu_177_p2;
wire   [0:0] tmp_3_fu_187_p3;
wire   [14:0] add_ln144_fu_182_p2;
wire   [14:0] select_ln144_fu_195_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln139_fu_126_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_263_reg_238 <= zext_ln142_fu_150_p1;
        conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_264_reg_243 <= zext_ln142_fu_150_p1;
        tmp_reg_248 <= ap_sig_allocacmp_bw_1[32'd7];
    end
end
...
always @ (*) begin
    if ((((tmp_reg_248 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((icmp_ln139_fu_126_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1)))) begin
...
always @ (*) begin
    if ((((tmp_reg_248 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((icmp_ln139_fu_126_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1)))) begin
...
assign add_ln139_fu_132_p2 = (ap_sig_allocacmp_bw_1 + 8'd1);

assign add_ln142_fu_177_p2 = ($signed(tmp_2_fu_164_p4) + $signed(shl_ln142_cast_cast_reg_225));
...
assign conv3_ap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_1_d0 = select_ln144_1_cast_fu_203_p1;

assign conv3_mulmulmulmulap_fixed_255_255_ap_fixed_32_5_5_ap_fixed_ap_fixed_255_d0 = select_ln144_1_cast_fu_203_p1;

assign icmp_ln139_fu_126_p2 = ((ap_sig_allocacmp_bw_1 == 8'd255) ? 1'b1 : 1'b0);

assign select_ln144_1_cast_fu_203_p1 = select_ln144_fu_195_p3;

assign select_ln144_fu_195_p3 = ((tmp_3_fu_187_p3[0:0] == 1'b1) ? 15'd0 : add_ln144_fu_182_p2);

assign sext_ln142_cast_fu_110_p1 = $signed(sext_ln142);

assign shl_ln142_cast_cast_fu_114_p1 = $signed(shl_ln142_cast);

assign tmp_3_fu_187_p3 = add_ln142_fu_177_p2[32'd15];

assign tmp_s_fu_142_p3 = {{or_ln139}, {trunc_ln139_fu_138_p1}};

assign trunc_ln139_fu_138_p1 = ap_sig_allocacmp_bw_1[6:0];

assign trunc_ln142_fu_173_p1 = tmp_2_fu_164_p4[14:0];
