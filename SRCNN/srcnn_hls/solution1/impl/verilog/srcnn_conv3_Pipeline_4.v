...
wire   [0:0] exitcond61711_fu_134_p2;
...
reg   [0:0] exitcond61711_reg_207;
reg   [0:0] tmp_reg_221;
wire   [23:0] tmp_10_fu_182_p4;
reg   [23:0] tmp_10_reg_231;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond61711_fu_134_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond61711_reg_207 == 1'd0))) begin
        tmp_10_reg_231 <= tmp_10_fu_182_p4;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond61711_fu_134_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_221 <= ap_sig_allocacmp_loop_index_0_i_load[32'd7];
    end
end

always @ (*) begin
    if (((exitcond61711_fu_134_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond61711_reg_207 == 1'd1))) begin
...
assign empty_254_fu_146_p1 = ap_sig_allocacmp_loop_index_0_i_load[6:0];

assign empty_fu_140_p2 = (ap_sig_allocacmp_loop_index_0_i_load + 8'd1);

assign exitcond61711_fu_134_p2 = ((ap_sig_allocacmp_loop_index_0_i_load == 8'd255) ? 1'b1 : 1'b0);
...
assign m_axi_o_WDATA = tmp_10_reg_231;
...
assign tmp_69_fu_150_p3 = {{bh}, {empty_254_fu_146_p1}};
