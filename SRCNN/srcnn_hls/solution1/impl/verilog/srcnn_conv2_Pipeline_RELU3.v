...
module srcnn_conv2_Pipeline_RELU3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln111_1_fu_114_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln108_fu_92_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        output_fm_buffer_addr_reg_189 <= zext_ln111_1_fu_114_p1;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        output_fm_buffer_address0 = zext_ln111_1_fu_114_p1;
    end else begin
...
assign add_ln108_fu_98_p2 = (ap_sig_allocacmp_bw + 8'd1);

assign add_ln111_fu_108_p2 = (sub_ln111_2 + zext_ln111_fu_104_p1);
...
assign bitcast_ln113_fu_124_p1 = add15_1_i_reg_199;

assign grp_fu_2177_p_ce = 1'b1;

assign grp_fu_2177_p_din0 = add15_1_i_reg_199;
...
assign icmp_ln108_fu_92_p2 = ((ap_sig_allocacmp_bw == 8'd255) ? 1'b1 : 1'b0);
...
assign output_fm_buffer_d0 = ((and_ln113_fu_159_p2[0:0] == 1'b1) ? 32'd0 : add15_1_i_reg_199);

assign tmp_1_fu_127_p4 = {{bitcast_ln113_fu_124_p1[30:23]}};

assign trunc_ln113_fu_137_p1 = bitcast_ln113_fu_124_p1[22:0];

assign zext_ln111_1_fu_114_p1 = add_ln111_fu_108_p2;

assign zext_ln111_fu_104_p1 = ap_sig_allocacmp_bw;

endmodule //srcnn_conv2_Pipeline_RELU3
