...
wire   [0:0] icmp_ln74_fu_88_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln76_fu_112_p1;
reg   [7:0] w_fu_42;
wire   [7:0] add_ln74_fu_94_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln74_fu_88_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln74_fu_88_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_118_p3 == 1'd0) & (icmp_ln74_fu_88_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_118_p3 == 1'd1) & (icmp_ln74_fu_88_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln74_fu_94_p2 = (ap_sig_allocacmp_w_2 + 8'd1);
...
assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_1_address0 = zext_ln76_fu_112_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_1_d0 = 32'd0;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_address0 = zext_ln76_fu_112_p1;

assign conv1_float_255_255_float_1_9_9_float_float_255_255_ou_d0 = 32'd0;

assign empty_fu_100_p1 = ap_sig_allocacmp_w_2[6:0];

assign icmp_ln74_fu_88_p2 = ((ap_sig_allocacmp_w_2 == 8'd255) ? 1'b1 : 1'b0);

assign tmp_fu_118_p3 = ap_sig_allocacmp_w_2[32'd7];

assign tmp_s_fu_104_p3 = {{tmp_11}, {empty_fu_100_p1}};

assign zext_ln76_fu_112_p1 = tmp_s_fu_104_p3;
