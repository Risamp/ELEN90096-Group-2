...
attribute shreg_extract : string;
    ...
    signal exitcond105222_fu_177_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_146_fu_262_p5 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_146_reg_324 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_cast_fu_218_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal phi_urem3191_fu_78 : STD_LOGIC_VECTOR (7 downto 0);
    signal idx_urem3193_fu_250_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal phi_mul3189_fu_82 : STD_LOGIC_VECTOR (16 downto 0);
    signal next_mul3190_fu_192_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal ap_sig_allocacmp_phi_mul3189_load : STD_LOGIC_VECTOR (16 downto 0);
    signal loop_index_0_i972_fu_86 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_fu_183_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_sig_allocacmp_loop_index_0_i972_load : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_fu_198_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_412_cast_fu_208_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal empty_412_fu_212_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal next_urem3192_fu_238_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_411_fu_244_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_146_fu_262_p4 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    mux_3_2_16_1_1_U46 : component srcnn_mux_3_2_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    port map (
        ...
        din3 => tmp_146_fu_262_p4,
        dout => tmp_146_fu_262_p5);
    ...
    loop_index_0_i972_fu_86_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond105222_fu_177_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index_0_i972_fu_86 <= empty_fu_183_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index_0_i972_fu_86 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;

    phi_mul3189_fu_82_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond105222_fu_177_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    phi_mul3189_fu_82 <= next_mul3190_fu_192_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    phi_mul3189_fu_82 <= ap_const_lv17_0;
                end if;
            end if; 
        end if;
    end process;

    phi_urem3191_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    phi_urem3191_fu_78 <= ap_const_lv8_0;
                elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                    phi_urem3191_fu_78 <= idx_urem3193_fu_250_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_146_reg_324 <= tmp_146_fu_262_p5;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond105222_fu_177_p2)
    begin
        if (((exitcond105222_fu_177_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index_0_i972_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, loop_index_0_i972_fu_86)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index_0_i972_load <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_loop_index_0_i972_load <= loop_index_0_i972_fu_86;
        end if; 
    end process;


    ap_sig_allocacmp_phi_mul3189_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, phi_mul3189_fu_82)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_phi_mul3189_load <= ap_const_lv17_0;
        else 
            ap_sig_allocacmp_phi_mul3189_load <= phi_mul3189_fu_82;
        end if; 
    end process;
    ...
    empty_411_fu_244_p2 <= "1" when (unsigned(next_urem3192_fu_238_p2) < unsigned(ap_const_lv8_3)) else "0";
    empty_412_fu_212_p2 <= std_logic_vector(unsigned(mul_ln140) + unsigned(tmp_412_cast_fu_208_p1));
    empty_fu_183_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_0_i972_load) + unsigned(ap_const_lv8_1));
    exitcond105222_fu_177_p2 <= "1" when (ap_sig_allocacmp_loop_index_0_i972_load = ap_const_lv8_FF) else "0";
    idx_urem3193_fu_250_p3 <= 
        next_urem3192_fu_238_p2 when (empty_411_fu_244_p2(0) = '1') else 
        ap_const_lv8_0;
    ...
    m_axi_bundle_2_WDATA <= tmp_146_reg_324;
    ...
    next_mul3190_fu_192_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_phi_mul3189_load) + unsigned(ap_const_lv17_156));
    next_urem3192_fu_238_p2 <= std_logic_vector(unsigned(phi_urem3191_fu_78) + unsigned(ap_const_lv8_1));
    p_cast_fu_218_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_412_fu_212_p2),64));
    tmp_146_fu_262_p4 <= phi_urem3191_fu_78(2 - 1 downto 0);
    tmp_412_cast_fu_208_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_198_p4),14));
    tmp_fu_198_p4 <= ap_sig_allocacmp_phi_mul3189_load(16 downto 10);
end behav;
