...
set C_modelArgList {
	{ select_ln63 float 32 regular  }
	{ or_ln63 int 5 regular  }
	{ indvars_iv117_udiv_cast int 2 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln63", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "or_ln63", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "indvars_iv117_udiv_cast", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln63 sc_in sc_lv 32 signal 0 } 
	{ or_ln63 sc_in sc_lv 5 signal 1 } 
	{ indvars_iv117_udiv_cast sc_in sc_lv 2 signal 2 } 
	{ zext_ln52_1 sc_in sc_lv 8 signal 3 } 
	{ trunc_ln sc_in sc_lv 1 signal 4 } 
	{ zext_ln52 sc_in sc_lv 8 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln63", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "select_ln63", "role": "default" }} , 
 	{ "name": "or_ln63", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "or_ln63", "role": "default" }} , 
 	{ "name": "indvars_iv117_udiv_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "indvars_iv117_udiv_cast", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_32_1_1_U22", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_32_1_1_U23", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_4_2_32_1_1_U26", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_3ns_9ns_9ns_11_4_1_U27", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_3ns_9ns_8ns_11_4_1_U28", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_3ns_9ns_9ns_11_4_1_U29", "Parent" : "0"},
...
set Spec2ImplPortList { 
	select_ln63 { ap_none {  { select_ln63 in_data 0 32 } } }
	or_ln63 { ap_none {  { or_ln63 in_data 0 5 } } }
	indvars_iv117_udiv_cast { ap_none {  { indvars_iv117_udiv_cast in_data 0 2 } } }
