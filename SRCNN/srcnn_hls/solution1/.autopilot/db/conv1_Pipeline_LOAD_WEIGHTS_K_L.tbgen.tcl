...
set C_modelArgList {
	...
	{ weight_buffer_2_0 float 32 regular {array 648 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "w1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "conv1_weights","offset": { "type": "dynamic","port_name": "conv1_weights","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "weight_buffer_2_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ weight_buffer_2_0_address0 sc_out sc_lv 10 signal 2 } 
	{ weight_buffer_2_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ weight_buffer_2_0_we0 sc_out sc_logic 1 signal 2 } 
	{ weight_buffer_2_0_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_buffer_2_0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "weight_buffer_2_0", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	weight_buffer_2_0 { ap_memory {  { weight_buffer_2_0_address0 mem_address 1 10 }  { weight_buffer_2_0_ce0 mem_ce 1 1 }  { weight_buffer_2_0_we0 mem_we 1 1 }  { weight_buffer_2_0_d0 mem_din 1 32 } } }
}
