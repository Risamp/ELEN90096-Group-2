           ...
           ftmap_t output_ftmap[32][255][255])
{
  ...
  int padding = (1 - 1) / 2;
     ...
     VITIS_LOOP_17_1: for (int n2 = 0; n2 < 32; n2++) {
         ...
         VITIS_LOOP_21_2: for (int h = 0; h < 255; h++) {
             VITIS_LOOP_22_3: for (int w = 0; w < 255; w++) {
                 ...
                 VITIS_LOOP_25_4: for (int f2h = 0; f2h < 1; f2h++) {
                     VITIS_LOOP_26_5: for (int f2w = 0; f2w < 1; f2w++) {


       int yPixelClamped = clamp(h + f2h - padding, 0, 255 - 1);
       int xPixelClamped = clamp(w + f2w - padding, 0, 255 - 1);


                         VITIS_LOOP_33_6: for (int n1 = 0; n1 < 64; n1++) {
