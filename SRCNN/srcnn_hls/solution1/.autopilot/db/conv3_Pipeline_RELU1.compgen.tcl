...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_shl_ln142_cast \
    op interface \
    ports { shl_ln142_cast { I 14 vector } } \
} "
}
