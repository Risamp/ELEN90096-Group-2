...
set C_modelArgMapList {[ 
	{ "Name" : "tmp_547", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_547 sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_547", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "tmp_547", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_32_1_1_U94", "Parent" : "0"},
...
set Spec2ImplPortList { 
	tmp_547 { ap_none {  { tmp_547 in_data 0 7 } } }
