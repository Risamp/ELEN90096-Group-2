...
set id 18
set name srcnn_ama_addmuladd_4ns_5ns_5ns_5ns_10_4_1
...
set ce_signed 0
set out_width 10
set arg_lists {i0 {4 0 +} i1 {5 0 +} s {5 0 +} i2 {5 0 +} m {10 1 +} i3 {5 0 +} p {10 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename input_fm_buffer_2_0 \
    op interface \
    ports { input_fm_buffer_2_0_address0 { O 10 vector } input_fm_buffer_2_0_ce0 { O 1 bit } input_fm_buffer_2_0_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_fm_buffer_2_0'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_output_fm_buffer_1_load \
    op interface \
    ports { output_fm_buffer_1_load { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln47_2 \
    op interface \
    ports { select_ln47_2 { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln47 \
    op interface \
    ports { select_ln47 { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 25 \
    name add51_lcssa17_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add51_lcssa17_out \
    op interface \
    ports { add51_lcssa17_out { O 32 vector } add51_lcssa17_out_ap_vld { O 1 bit } } \
} "
}
