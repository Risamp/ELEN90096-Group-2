...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv1_output_ftmap_address0 { O 22 vector } conv1_output_ftmap_ce0 { O 1 bit } conv1_output_ftmap_we0 { O 1 bit } conv1_output_ftmap_d0 { O 32 vector } conv1_output_ftmap_q0 { I 32 vector } } \
} "
} else {
