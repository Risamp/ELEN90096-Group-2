...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln135_1 \
    op interface \
    ports { sext_ln135_1 { I 30 vector } } \
} "
}
