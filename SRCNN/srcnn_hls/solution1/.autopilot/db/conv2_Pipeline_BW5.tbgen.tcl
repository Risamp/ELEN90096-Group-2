...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln65", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln65 sc_in sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln65", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "add_ln65", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln65 { ap_none {  { add_ln65 in_data 0 9 } } }
