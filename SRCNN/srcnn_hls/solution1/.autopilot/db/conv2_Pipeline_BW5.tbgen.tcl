...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln64", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln64 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln64", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "add_ln64", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln64 { ap_none {  { add_ln64 in_data 0 8 } } }
