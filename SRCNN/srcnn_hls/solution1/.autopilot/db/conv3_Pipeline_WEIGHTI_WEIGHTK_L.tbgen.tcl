...
set C_modelArgList {
	...
	{ sext_ln119 int 63 regular  }
	{ weight_buffer_0 int 16 regular {array 800 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "w3", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "conv3_weights","offset": { "type": "dynamic","port_name": "conv3_weights","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln119", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "weight_buffer_0", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ m_axi_w3_WDATA sc_out sc_lv 16 signal 0 } 
	{ m_axi_w3_WSTRB sc_out sc_lv 2 signal 0 } 
	...
	{ m_axi_w3_RDATA sc_in sc_lv 16 signal 0 } 
	{ m_axi_w3_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_w3_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_w3_RFIFONUM sc_in sc_lv 14 signal 0 } 
	...
	{ sext_ln119 sc_in sc_lv 63 signal 1 } 
	...
	{ weight_buffer_0_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln119", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln119", "role": "default" }} , 
 	...
 	{ "name": "weight_buffer_0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "weight_buffer_0", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln119 { ap_none {  { sext_ln119 in_data 0 63 } } }
	weight_buffer_0 { ap_memory {  { weight_buffer_0_address0 mem_address 1 10 }  { weight_buffer_0_ce0 mem_ce 1 1 }  { weight_buffer_0_we0 mem_we 1 1 }  { weight_buffer_0_d0 mem_din 1 16 } } }
}
