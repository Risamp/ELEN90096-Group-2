...
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln90_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_ln90_1 sc_in sc_lv 14 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln90_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln90_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sub_ln90_1 { ap_none {  { sub_ln90_1 in_data 0 14 } } }
