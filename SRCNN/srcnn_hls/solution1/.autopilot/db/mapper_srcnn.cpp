...
using hls::sim::Byte;
extern "C" void srcnn(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int, int, int, int, int, int);
...
std::vector<Byte<4>> __xlx_conv1_output_ftmap__tmp_vec;
for (size_t i = 0; i < 4161600; ++i){
__xlx_conv1_output_ftmap__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_conv1_output_ftmap)[i]);
}
...
((Byte<4>*)__xlx_apatb_param_conv1_output_ftmap)[i] = __xlx_conv1_output_ftmap__tmp_vec[__xlx_offset_param_conv1_output_ftmap+i];
}
