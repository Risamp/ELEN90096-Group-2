...
using hls::sim::Byte;
extern "C" void srcnn(Byte<4>*, Byte<2>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, Byte<2>*, int, int, Byte<2>*, int, int, volatile void *, int);
...
std::vector<Byte<2>> __xlx_conv1_biases__tmp_vec;
for (size_t i = 0; i < 64; ++i){
__xlx_conv1_biases__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_conv1_biases)[i]);
}
...
((Byte<2>*)__xlx_apatb_param_conv1_biases)[i] = __xlx_conv1_biases__tmp_vec[__xlx_offset_param_conv1_biases+i];
}
// print __xlx_apatb_param_conv2_biases
for (size_t i = 0; i < __xlx_size_param_conv2_biases; ++i) {
((Byte<2>*)__xlx_apatb_param_conv2_biases)[i] = __xlx_conv2_biases__tmp_vec[__xlx_offset_param_conv2_biases+i];
}
}
