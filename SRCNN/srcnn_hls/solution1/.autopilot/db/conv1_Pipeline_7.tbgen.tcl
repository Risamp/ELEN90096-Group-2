set moduleName conv1_Pipeline_7
set isTopModule 0
...
set C_modelName {conv1_Pipeline_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ i2 int 32 regular {axi_master 1}  }
	{ sext_ln162 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "i2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "conv1_output_ftmap","offset": { "type": "dynamic","port_name": "conv1_output_ftmap","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln162", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln162 sc_in sc_lv 62 signal 1 } 
	{ sub_ln155_3 sc_in sc_lv 14 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln162", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln162", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_32_1_1_U233", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln162 { ap_none {  { sext_ln162 in_data 0 62 } } }
