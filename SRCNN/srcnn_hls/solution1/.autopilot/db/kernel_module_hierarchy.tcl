...
"SubInsts" : [
	...
	{"Name" : "grp_conv2_fu_316","ID" : "38","Type" : "sequential",
		...
		"SubInsts" : [
		{"Name" : "grp_conv2_Pipeline_LOAD_INPUT_BH_L_fu_295","ID" : "40","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "LOAD_INPUT_BH_L","ID" : "41","Type" : "pipeline"},]},],
		"SubLoops" : [
		{"Name" : "TILE_OUT","ID" : "42","Type" : "no",
			"SubInsts" : [
			{"Name" : "grp_conv2_Pipeline_LOAD_WEIGHTS_L_fu_309","ID" : "43","Type" : "sequential",
					"SubLoops" : [
					{"Name" : "LOAD_WEIGHTS_L","ID" : "44","Type" : "pipeline"},]},
			{"Name" : "grp_conv2_Pipeline_OUT_ROW_COL_fu_318","ID" : "45","Type" : "sequential",
					"SubLoops" : [
			...
			{"Name" : "EXPORT","ID" : "47","Type" : "no",
				...
				{"Name" : "BH","ID" : "48","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_conv2_Pipeline_RELU_fu_336","ID" : "49","Type" : "sequential",
							"SubLoops" : [
							{"Name" : "RELU","ID" : "50","Type" : "pipeline"},]},
					{"Name" : "grp_conv2_Pipeline_5_fu_348","ID" : "51","Type" : "sequential",
							"SubLoops" : [
							{"Name" : "Loop 1","ID" : "52","Type" : "pipeline"},]},
					{"Name" : "grp_conv2_Pipeline_RELU6_fu_362","ID" : "53","Type" : "sequential",
							"SubLoops" : [
							{"Name" : "RELU","ID" : "54","Type" : "pipeline"},]},
					{"Name" : "grp_conv2_Pipeline_7_fu_374","ID" : "55","Type" : "sequential",
							"SubLoops" : [
							{"Name" : "Loop 1","ID" : "56","Type" : "pipeline"},]},]},]},
			{"Name" : "CLEAR","ID" : "57","Type" : "no",
				"SubInsts" : [
				{"Name" : "grp_conv2_Pipeline_BW_fu_388","ID" : "58","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "BW","ID" : "59","Type" : "pipeline"},]},
				{"Name" : "grp_conv2_Pipeline_BW7_fu_399","ID" : "60","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "BW","ID" : "61","Type" : "pipeline"},]},
				{"Name" : "grp_conv2_Pipeline_BW8_fu_410","ID" : "62","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "BW","ID" : "63","Type" : "pipeline"},]},]},]},]},]},
	{"Name" : "grp_conv3_fu_346","ID" : "64","Type" : "sequential",
		"SubLoops" : [
