...
"SubInsts" : [
	{"Name" : "grp_srcnn_Pipeline_1_fu_222","ID" : "1","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "Loop 1","ID" : "2","Type" : "pipeline"},]},
	{"Name" : "grp_srcnn_Pipeline_2_fu_229","ID" : "3","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "Loop 1","ID" : "4","Type" : "pipeline"},]},
	{"Name" : "grp_conv1_fu_236","ID" : "5","Type" : "sequential",
		"SubLoops" : [
		{"Name" : "TILE_OUT_TILE_ROW","ID" : "6","Type" : "no",
		"SubInsts" : [
		{"Name" : "grp_load_input_buffer_c1_fu_550","ID" : "7","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "BH","ID" : "8","Type" : "no",
				"SubLoops" : [
				{"Name" : "BH.1","ID" : "9","Type" : "no"},]},]},
		{"Name" : "grp_export_output_buffer_c1_fu_574","ID" : "10","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "RELU1_BH","ID" : "11","Type" : "no",
				"SubInsts" : [
				{"Name" : "grp_export_output_buffer_c1_Pipeline_BW_fu_291","ID" : "12","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "BW","ID" : "13","Type" : "pipeline"},]},]},
				{"Name" : "EXPORT","ID" : "14","Type" : "no",
				"SubLoops" : [
				{"Name" : "ROW","ID" : "15","Type" : "no",
					"SubLoops" : [
					{"Name" : "ROW.1","ID" : "16","Type" : "no"},]},
				{"Name" : "ROW","ID" : "17","Type" : "no",
					"SubLoops" : [
					{"Name" : "ROW.1","ID" : "18","Type" : "no"},]},]},]},],
		"SubLoops" : [
		{"Name" : "LOAD_WEIGHTS","ID" : "19","Type" : "no",
			"SubLoops" : [
			{"Name" : "KH","ID" : "20","Type" : "no",
				"SubLoops" : [
				{"Name" : "KW","ID" : "21","Type" : "no"},]},]},
		{"Name" : "OUT_ROW","ID" : "22","Type" : "no",
			"SubLoops" : [
			{"Name" : "COL","ID" : "23","Type" : "no",
				"SubInsts" : [
				{"Name" : "grp_conv1_Pipeline_KR_KC_fu_589","ID" : "24","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "KR_KC","ID" : "25","Type" : "pipeline"},]},
				{"Name" : "grp_conv1_Pipeline_KR_KC1_fu_624","ID" : "26","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "KR_KC","ID" : "27","Type" : "pipeline"},]},
				{"Name" : "grp_conv1_Pipeline_KR_KC2_fu_659","ID" : "28","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "KR_KC","ID" : "29","Type" : "pipeline"},]},
				{"Name" : "grp_conv1_Pipeline_KR_KC3_fu_694","ID" : "30","Type" : "sequential",
						"SubLoops" : [
						{"Name" : "KR_KC","ID" : "31","Type" : "pipeline"},]},]},]},
		{"Name" : "CLEAR","ID" : "32","Type" : "no",
			"SubLoops" : [
			{"Name" : "BH","ID" : "33","Type" : "no",
				"SubLoops" : [
				{"Name" : "BW","ID" : "34","Type" : "no"},]},]},]},]},
	{"Name" : "grp_conv2_fu_279","ID" : "35","Type" : "sequential",
		"SubLoops" : [
	...
	{"Name" : "grp_conv3_fu_312","ID" : "55","Type" : "sequential",
		"SubLoops" : [
