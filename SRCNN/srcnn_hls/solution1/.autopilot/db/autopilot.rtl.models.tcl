set SynModuleInfo {
  ...
  {SRCNAME srcnn_Pipeline_OUT_BUFFER_TY_OUT_BUFFER_TX MODELNAME srcnn_Pipeline_OUT_BUFFER_TY_OUT_BUFFER_TX RTLNAME srcnn_srcnn_Pipeline_OUT_BUFFER_TY_OUT_BUFFER_TX}
  {SRCNAME srcnn_Pipeline_5 MODELNAME srcnn_Pipeline_5 RTLNAME srcnn_srcnn_Pipeline_5}
  ...
  {SRCNAME srcnn MODELNAME srcnn RTLNAME srcnn IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME srcnn_output_fm_buffer_1_RAM_AUTO_1R1W RTLNAME srcnn_output_fm_buffer_1_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
