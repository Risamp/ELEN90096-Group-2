set SynModuleInfo {
  {SRCNAME conv1 MODELNAME conv1 RTLNAME srcnn_conv1
    SUBMODULES {
      ...
      {MODELNAME srcnn_conv1_input_fm_buffer_1_0_RAM_AUTO_1R1W RTLNAME srcnn_conv1_input_fm_buffer_1_0_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
