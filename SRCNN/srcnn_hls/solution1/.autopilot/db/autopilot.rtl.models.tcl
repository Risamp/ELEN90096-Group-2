set SynModuleInfo {
  ...
  {SRCNAME load_input_buffer_c1 MODELNAME load_input_buffer_c1 RTLNAME srcnn_load_input_buffer_c1
    SUBMODULES {
      ...
      {MODELNAME srcnn_mul_3ns_10ns_12_1_1 RTLNAME srcnn_mul_3ns_10ns_12_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME conv1_Pipeline_KR_KC MODELNAME conv1_Pipeline_KR_KC RTLNAME srcnn_conv1_Pipeline_KR_KC
    SUBMODULES {
      ...
      {MODELNAME srcnn_mac_muladd_3ns_9ns_9ns_11_4_1 RTLNAME srcnn_mac_muladd_3ns_9ns_9ns_11_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
      {MODELNAME srcnn_mac_muladd_3ns_9ns_8ns_11_4_1 RTLNAME srcnn_mac_muladd_3ns_9ns_8ns_11_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME conv1_Pipeline_BW4 MODELNAME conv1_Pipeline_BW4 RTLNAME srcnn_conv1_Pipeline_BW4}
  {SRCNAME conv1_Pipeline_BW5 MODELNAME conv1_Pipeline_BW5 RTLNAME srcnn_conv1_Pipeline_BW5}
  {SRCNAME conv1_Pipeline_EXPORT_ROW_L MODELNAME conv1_Pipeline_EXPORT_ROW_L RTLNAME srcnn_conv1_Pipeline_EXPORT_ROW_L
    SUBMODULES {
  ...
  {SRCNAME conv1_Pipeline_BW6 MODELNAME conv1_Pipeline_BW6 RTLNAME srcnn_conv1_Pipeline_BW6}
  {SRCNAME conv1_Pipeline_BW7 MODELNAME conv1_Pipeline_BW7 RTLNAME srcnn_conv1_Pipeline_BW7}
  ...
  {SRCNAME conv1 MODELNAME conv1 RTLNAME srcnn_conv1
    SUBMODULES {
      ...
      {MODELNAME srcnn_conv1_p_ZZ5conv1PA255_A255_fPA1_A9_A9_fPfS1_E13weight_buffer_0_0_RAM_AUTO_1R1W RTLNAME srcnn_conv1_p_ZZ5conv1PA255_A255_fPA1_A9_A9_fPfS1_E13weight_buffer_0_0_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
