set moduleName srcnn_Pipeline_OUT_BUFFER_TY_OUT_BUFFER_TX
set isTopModule 0
...
set C_modelName {srcnn_Pipeline_OUT_BUFFER_TY_OUT_BUFFER_TX}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "input_ftmap","offset": { "type": "dynamic","port_name": "input_ftmap","bundle": "control"},},{"cName": "conv1_weights","offset": { "type": "dynamic","port_name": "conv1_weights","bundle": "control"},},{"cName": "conv1_biases","offset": { "type": "dynamic","port_name": "conv1_biases","bundle": "control"},"direction": "READONLY"},{"cName": "conv1_output_ftmap","offset": { "type": "dynamic","port_name": "conv1_output_ftmap","bundle": "control"},"direction": "READWRITE"},{"cName": "conv2_weights","offset": { "type": "dynamic","port_name": "conv2_weights","bundle": "control"},"direction": "READONLY"},{"cName": "conv2_biases","offset": { "type": "dynamic","port_name": "conv2_biases","bundle": "control"},"direction": "READONLY"},{"cName": "conv2_output_ftmap","offset": { "type": "dynamic","port_name": "conv2_output_ftmap","bundle": "control"},"direction": "READWRITE"},{"cName": "conv3_weights","offset": { "type": "dynamic","port_name": "conv3_weights","bundle": "control"},"direction": "READONLY"},{"cName": "conv3_biases","offset": { "type": "dynamic","port_name": "conv3_biases","bundle": "control"},"direction": "READONLY"},{"cName": "output_ftmap","offset": { "type": "dynamic","port_name": "output_ftmap","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "ti_cast8", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_3", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln115", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "conv1_output_ftmap", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_shl_mid2 sc_in sc_lv 8 signal 2 } 
	{ add_ln118_5 sc_in sc_lv 12 signal 3 } 
	{ empty sc_in sc_lv 32 signal 4 } 
	{ ti_cast8 sc_in sc_lv 4 signal 5 } 
	{ tmp_3 sc_in sc_lv 8 signal 6 } 
	{ zext_ln115 sc_in sc_lv 24 signal 7 } 
	{ conv1_output_ftmap sc_in sc_lv 64 signal 8 } 
	{ output_fm_buffer_1_address0 sc_out sc_lv 15 signal 9 } 
	{ output_fm_buffer_1_ce0 sc_out sc_logic 1 signal 9 } 
	{ output_fm_buffer_1_q0 sc_in sc_lv 32 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ti_cast8", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ti_cast8", "role": "default" }} , 
 	...
 	{ "name": "conv1_output_ftmap", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv1_output_ftmap", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	ti_cast8 { ap_none {  { ti_cast8 in_data 0 4 } } }
	tmp_3 { ap_none {  { tmp_3 in_data 0 8 } } }
	zext_ln115 { ap_none {  { zext_ln115 in_data 0 24 } } }
	conv1_output_ftmap { ap_none {  { conv1_output_ftmap in_data 0 64 } } }
