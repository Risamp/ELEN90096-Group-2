set moduleName conv1_Pipeline_BW4
set isTopModule 0
...
set C_modelName {conv1_Pipeline_BW4}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln151_1 int 12 regular  }
	{ trunc_ln10 int 3 regular  }
	{ bitcast_ln145 float 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln151_1", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln10", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "bitcast_ln145", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_ln151_1 sc_in sc_lv 12 signal 0 } 
	{ trunc_ln10 sc_in sc_lv 3 signal 1 } 
	{ bitcast_ln145 sc_in sc_lv 32 signal 2 } 
	...
	{ grp_fu_2141_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_2141_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln151_1", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sub_ln151_1", "role": "default" }} , 
 	{ "name": "trunc_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "trunc_ln10", "role": "default" }} , 
 	{ "name": "bitcast_ln145", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bitcast_ln145", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_2141_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_2141_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_2141_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_2141_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U133", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sub_ln151_1 { ap_none {  { sub_ln151_1 in_data 0 12 } } }
	trunc_ln10 { ap_none {  { trunc_ln10 in_data 0 3 } } }
	bitcast_ln145 { ap_none {  { bitcast_ln145 in_data 0 32 } } }
