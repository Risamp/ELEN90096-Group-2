...
set C_modelArgMapList {[ 
	{ "Name" : "phi_mul4796", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ phi_mul4796 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_mul4796", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "phi_mul4796", "role": "default" }} , 
...
set Spec2ImplPortList { 
	phi_mul4796 { ap_none {  { phi_mul4796 in_data 0 8 } } }
