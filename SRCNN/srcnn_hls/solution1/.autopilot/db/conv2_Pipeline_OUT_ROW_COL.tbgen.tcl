...
set C_modelArgList {
	...
	{ input_fm_buffer int 32 regular {array 48960 { 1 3 } 1 1 } {global 0}  }
	{ output_fm_buffer int 32 regular {array 3060 { 0 1 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_18s_49_1_1_U199", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "195844", "Max" : "195844"}
	, {"Name" : "Interval", "Min" : "195844", "Max" : "195844"}
]}
...
set Spec2ImplPortList { 
	...
	input_fm_buffer { ap_memory {  { input_fm_buffer_address0 mem_address 1 16 }  { input_fm_buffer_ce0 mem_ce 1 1 }  { input_fm_buffer_q0 in_data 0 32 } } }
	output_fm_buffer { ap_memory {  { output_fm_buffer_address0 mem_address 1 12 }  { output_fm_buffer_ce0 mem_ce 1 1 }  { output_fm_buffer_we0 mem_we 1 1 }  { output_fm_buffer_d0 mem_din 1 32 }  { output_fm_buffer_address1 MemPortADDR2 1 12 }  { output_fm_buffer_ce1 MemPortCE2 1 1 }  { output_fm_buffer_q1 in_data 0 32 } } }
}
