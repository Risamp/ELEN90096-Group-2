...
set C_modelArgList {
	...
	{ h int 8 regular  }
	{ input_fm_buffer float 32 regular {array 58016 { 0 0 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ input_fm_buffer_address0 sc_out sc_lv 16 signal 3 } 
	{ input_fm_buffer_ce0 sc_out sc_logic 1 signal 3 } 
	{ input_fm_buffer_we0 sc_out sc_logic 1 signal 3 } 
	{ input_fm_buffer_d0 sc_out sc_lv 32 signal 3 } 
	{ input_fm_buffer_address1 sc_out sc_lv 16 signal 3 } 
	{ input_fm_buffer_ce1 sc_out sc_logic 1 signal 3 } 
	{ input_fm_buffer_we1 sc_out sc_logic 1 signal 3 } 
	{ input_fm_buffer_d1 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_fm_buffer_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_fm_buffer", "role": "we1" }} , 
 	{ "name": "input_fm_buffer_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_fm_buffer", "role": "d1" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_19ns_24_1_1_U376", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_11s_10ns_21_1_1_U377", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "57355", "Max" : "57355"}
	, {"Name" : "Interval", "Min" : "57355", "Max" : "57355"}
]}
...
set Spec2ImplPortList { 
	...
	input_fm_buffer { ap_memory {  { input_fm_buffer_address0 mem_address 1 16 }  { input_fm_buffer_ce0 mem_ce 1 1 }  { input_fm_buffer_we0 mem_we 1 1 }  { input_fm_buffer_d0 mem_din 1 32 }  { input_fm_buffer_address1 MemPortADDR2 1 16 }  { input_fm_buffer_ce1 MemPortCE2 1 1 }  { input_fm_buffer_we1 MemPortWE2 1 1 }  { input_fm_buffer_d1 MemPortDIN2 1 32 } } }
}
