...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("conv1_biases_address0", 6, hls_out, 3, "ap_memory", "mem_address", 1),
	Port_Property("conv1_biases_ce0", 1, hls_out, 3, "ap_memory", "mem_ce", 1),
	Port_Property("conv1_biases_q0", 32, hls_in, 3, "ap_memory", "mem_dout", 1),
	Port_Property("conv2_biases_address0", 5, hls_out, 6, "ap_memory", "mem_address", 1),
	Port_Property("conv2_biases_ce0", 1, hls_out, 6, "ap_memory", "mem_ce", 1),
	Port_Property("conv2_biases_q0", 32, hls_in, 6, "ap_memory", "mem_dout", 1),
	Port_Property("conv3_biases", 32, hls_in, 9, "ap_none", "in_data", 1),
