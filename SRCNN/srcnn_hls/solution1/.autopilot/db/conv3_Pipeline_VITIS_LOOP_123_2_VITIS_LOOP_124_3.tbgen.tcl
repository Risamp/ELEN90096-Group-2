set moduleName conv3_Pipeline_VITIS_LOOP_123_2_VITIS_LOOP_124_3
set isTopModule 0
...
set C_modelName {conv3_Pipeline_VITIS_LOOP_123_2_VITIS_LOOP_124_3}
...
set C_modelArgList {
	...
	{ output_fm_buffer_0 float 32 regular {array 289 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ ti_cast20 sc_in sc_lv 4 signal 2 } 
	{ p_shl1 sc_in sc_lv 8 signal 3 } 
	{ output_ftmap sc_in sc_lv 64 signal 4 } 
	{ output_fm_buffer_0_address0 sc_out sc_lv 9 signal 6 } 
	{ output_fm_buffer_0_ce0 sc_out sc_logic 1 signal 6 } 
	{ output_fm_buffer_0_q0 sc_in sc_lv 32 signal 6 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5493", "Max" : "5493"}
	, {"Name" : "Interval", "Min" : "5493", "Max" : "5493"}
]}
...
set Spec2ImplPortList { 
	...
	output_fm_buffer_0 { ap_memory {  { output_fm_buffer_0_address0 mem_address 1 9 }  { output_fm_buffer_0_ce0 mem_ce 1 1 }  { output_fm_buffer_0_q0 mem_dout 0 32 } } }
}
