...
entry:
  ...
  %conv3_biases_copy = alloca [1 x i32], align 512
  ...
  %8 = bitcast %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"* %conv3_biases to [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]*
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"([1 x i32]* align 512 %17, [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %16)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"([1 x i32]* noalias nocapture align 512 "unpacked"="0.0" %dst, [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"([1 x i32]* %dst, [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"([1 x i32]* nocapture "unpacked"="0.0" %dst, [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %src.addr.0.0.05 = getelementptr [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"], [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %src, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>.18"([1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %16, [1 x i32]* align 512 %17)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>.18"([1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="0" %dst, [1 x i32]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>.21"([1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, [1 x i32]* %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>.21"([1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* "unpacked"="0" %dst, [1 x i32]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06 = getelementptr [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"], [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %1 = load i32, i32* %src.addr.0.0.05, align 4
  store i32 %1, i32* %dst.addr.0.0.06, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
...
declare void @apatb_srcnn_hw([1 x [255 x [255 x i32]]]*, [64 x [1 x [9 x [9 x i16]]]]*, [64 x i10]*, [64 x [255 x [255 x i32]]]*, [32 x [64 x [1 x [1 x i32]]]]*, [32 x i24]*, [32 x [255 x [255 x i32]]]*, [1 x [32 x [5 x [5 x i32]]]]*, [1 x i32]*, [1 x [255 x [255 x i32]]]*)
...
define void @srcnn_hw_stub_wrapper([1 x [255 x [255 x i32]]]*, [64 x [1 x [9 x [9 x i16]]]]*, [64 x i10]*, [64 x [255 x [255 x i32]]]*, [32 x [64 x [1 x [1 x i32]]]]*, [32 x i24]*, [32 x [255 x [255 x i32]]]*, [1 x [32 x [5 x [5 x i32]]]]*, [1 x i32]*, [1 x [255 x [255 x i32]]]*) #6 {
entry:
  ...
  %18 = alloca [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]
  ...
  %28 = bitcast [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %18 to %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"*
  %29 = bitcast [1 x [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]]* %19 to [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]*
  call void @srcnn_hw_stub([255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]* %20, [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]* %21, %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"* %22, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]* %23, [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]* %24, %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"* %25, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]* %26, [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]* %27, %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"* %28, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]* %29)
  call void @copy_in([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* %10, [1 x [255 x [255 x i32]]]* %0, [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* %11, [64 x [1 x [9 x [9 x i16]]]]* %1, [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* %12, [64 x i10]* %2, [64 x [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]]* %13, [64 x [255 x [255 x i32]]]* %3, [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* %14, [32 x [64 x [1 x [1 x i32]]]]* %4, [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* %15, [32 x i24]* %5, [32 x [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]]* %16, [32 x [255 x [255 x i32]]]* %6, [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* %17, [1 x [32 x [5 x [5 x i32]]]]* %7, [1 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]* %18, [1 x i32]* %8, [1 x [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]]* %19, [1 x [255 x [255 x i32]]]* %9)
  ret void
}

declare void @srcnn_hw_stub([255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]*, [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]*, [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]*, [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 3, AP_TRN, AP_WRAP, 0>"]]*)
