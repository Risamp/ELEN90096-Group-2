...
define void @apatb_srcnn_ir([255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %input_ftmap, [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "maxi" %conv1_weights, %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "maxi" %conv1_biases, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" "maxi" %conv1_output_ftmap, [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" "maxi" %conv2_weights, %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" "maxi" %conv2_biases, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="32" "maxi" %conv2_output_ftmap, [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %conv3_weights, %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" "maxi" %conv3_biases, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="1" "maxi" %output_ftmap) local_unnamed_addr #0 {
entry:
  ...
  %3 = bitcast [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %conv1_output_ftmap to [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  ...
  %6 = bitcast [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %conv2_output_ftmap to [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  ...
  %9 = bitcast [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %output_ftmap to [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  call fastcc void @copy_in([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* nonnull %0, [1 x [255 x [255 x i32]]]* %input_ftmap_copy, [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* nonnull %1, [64 x [1 x [9 x [9 x i16]]]]* %conv1_weights_copy, [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* nonnull %2, [64 x i10]* nonnull align 512 %conv1_biases_copy, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %3, [64 x [255 x [255 x i32]]]* %conv1_output_ftmap_copy, [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* nonnull %4, [32 x [64 x [1 x [1 x i32]]]]* %conv2_weights_copy, [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* nonnull %5, [32 x i24]* nonnull align 512 %conv2_biases_copy, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %6, [32 x [255 x [255 x i32]]]* %conv2_output_ftmap_copy, [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* nonnull %7, [1 x [32 x [5 x [5 x i32]]]]* nonnull align 512 %conv3_weights_copy, [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* nonnull %8, [1 x i15]* nonnull align 512 %conv3_biases_copy, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %9, [1 x [255 x [255 x i32]]]* %output_ftmap_copy)
  ...
  call void @copy_back([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* %0, [1 x [255 x [255 x i32]]]* %input_ftmap_copy, [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* %1, [64 x [1 x [9 x [9 x i16]]]]* %conv1_weights_copy, [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* %2, [64 x i10]* %conv1_biases_copy, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %3, [64 x [255 x [255 x i32]]]* %conv1_output_ftmap_copy, [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* %4, [32 x [64 x [1 x [1 x i32]]]]* %conv2_weights_copy, [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* %5, [32 x i24]* %conv2_biases_copy, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %6, [32 x [255 x [255 x i32]]]* %conv2_output_ftmap_copy, [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* %7, [1 x [32 x [5 x [5 x i32]]]]* %conv3_weights_copy, [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* %8, [1 x i15]* %conv3_biases_copy, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %9, [1 x [255 x [255 x i32]]]* %output_ftmap_copy)
...
define internal fastcc void @copy_in([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly "unpacked"="0", [1 x [255 x [255 x i32]]]* noalias "unpacked"="1", [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias readonly "unpacked"="2", [64 x [1 x [9 x [9 x i16]]]]* noalias "unpacked"="3", [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="4", [64 x i10]* noalias nocapture align 512 "unpacked"="5.0", [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly "unpacked"="6", [64 x [255 x [255 x i32]]]* noalias "unpacked"="7", [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias readonly "unpacked"="8", [32 x [64 x [1 x [1 x i32]]]]* noalias "unpacked"="9", [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="10", [32 x i24]* noalias nocapture align 512 "unpacked"="11.0", [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly "unpacked"="12", [32 x [255 x [255 x i32]]]* noalias "unpacked"="13", [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias readonly "unpacked"="14", [1 x [32 x [5 x [5 x i32]]]]* noalias align 512 "unpacked"="15", [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="16", [1 x i15]* noalias nocapture align 512 "unpacked"="17.0", [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly "unpacked"="18", [1 x [255 x [255 x i32]]]* noalias "unpacked"="19") unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.146"([64 x [255 x [255 x i32]]]* %7, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %6)
  ...
  call fastcc void @"onebyonecpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.109"([32 x [255 x [255 x i32]]]* %13, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %12)
  ...
  call fastcc void @"onebyonecpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.60"([1 x [255 x [255 x i32]]]* %19, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %18)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias %dst, [64 x [255 x [255 x i32]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %1 = icmp eq [64 x [255 x [255 x i32]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %dst, [64 x [255 x [255 x i32]]]* nonnull %src, i64 64)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, [64 x [255 x [255 x i32]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [64 x [255 x [255 x i32]]]* %src, null
  %1 = icmp eq [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, i64 0, i64 %for.loop.idx2
  %3 = getelementptr [64 x [255 x [255 x i32]]], [64 x [255 x [255 x i32]]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %dst.addr, [255 x [255 x i32]]* %3, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst, [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %src, null
  %1 = icmp eq [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx8 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %src.addr.0.0.05 = getelementptr [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"], [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %src, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"], [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias %dst, [32 x [255 x [255 x i32]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %1 = icmp eq [32 x [255 x [255 x i32]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %dst, [32 x [255 x [255 x i32]]]* nonnull %src, i64 32)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, [32 x [255 x [255 x i32]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [32 x [255 x [255 x i32]]]* %src, null
  %1 = icmp eq [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, i64 0, i64 %for.loop.idx2
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias %dst, [1 x [255 x [255 x i32]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %1 = icmp eq [1 x [255 x [255 x i32]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %dst, [1 x [255 x [255 x i32]]]* nonnull %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, [1 x [255 x [255 x i32]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [1 x [255 x [255 x i32]]]* %src, null
  %1 = icmp eq [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %dst, i64 0, i64 %for.loop.idx2
  %3 = getelementptr [1 x [255 x [255 x i32]]], [1 x [255 x [255 x i32]]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %dst.addr, [255 x [255 x i32]]* %3, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="0", [1 x [255 x [255 x i32]]]* noalias readonly "unpacked"="1", [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="2", [64 x [1 x [9 x [9 x i16]]]]* noalias readonly "unpacked"="3", [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="4", [64 x i10]* noalias nocapture readonly align 512 "unpacked"="5.0", [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="6", [64 x [255 x [255 x i32]]]* noalias readonly "unpacked"="7", [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="8", [32 x [64 x [1 x [1 x i32]]]]* noalias readonly "unpacked"="9", [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="10", [32 x i24]* noalias nocapture readonly align 512 "unpacked"="11.0", [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="12", [32 x [255 x [255 x i32]]]* noalias readonly "unpacked"="13", [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="14", [1 x [32 x [5 x [5 x i32]]]]* noalias readonly align 512 "unpacked"="15", [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="16", [1 x i15]* noalias nocapture readonly align 512 "unpacked"="17.0", [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="18", [1 x [255 x [255 x i32]]]* noalias readonly "unpacked"="19") unnamed_addr #4 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %6, [64 x [255 x [255 x i32]]]* %7)
  ...
  call fastcc void @"onebyonecpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %12, [32 x [255 x [255 x i32]]]* %13)
  ...
  call fastcc void @"onebyonecpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %18, [1 x [255 x [255 x i32]]]* %19)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.60"([1 x [255 x [255 x i32]]]* noalias %dst, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [1 x [255 x [255 x i32]]]* %dst, null
  %1 = icmp eq [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.63"([1 x [255 x [255 x i32]]]* nonnull %dst, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.63"([1 x [255 x [255 x i32]]]* %dst, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.66"([255 x [255 x i32]]* %3, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %src.addr, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.66"([255 x [255 x i32]]* %dst, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]], [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.69"([255 x i32]* %3, [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %src.addr, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.69"([255 x i32]* %dst, [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %src, null
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %dst, [255 x [255 x i32]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [255 x [255 x i32]]* %src, null
  %1 = icmp eq [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]], [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %dst, i64 0, i64 %for.loop.idx2
  %3 = getelementptr [255 x [255 x i32]], [255 x [255 x i32]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.78"([255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst.addr, [255 x i32]* %3, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.78"([255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst, [255 x i32]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [255 x i32]* %src, null
  %1 = icmp eq [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]* %dst, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.109"([32 x [255 x [255 x i32]]]* noalias %dst, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [32 x [255 x [255 x i32]]]* %dst, null
  %1 = icmp eq [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.112"([32 x [255 x [255 x i32]]]* nonnull %dst, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %src, i64 32)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.112"([32 x [255 x [255 x i32]]]* %dst, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.66"([255 x [255 x i32]]* %3, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %src.addr, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.146"([64 x [255 x [255 x i32]]]* noalias %dst, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [64 x [255 x [255 x i32]]]* %dst, null
  %1 = icmp eq [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.149"([64 x [255 x [255 x i32]]]* nonnull %dst, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* nonnull %src, i64 64)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.149"([64 x [255 x [255 x i32]]]* %dst, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]], [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>.66"([255 x [255 x i32]]* %3, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %src.addr, i64 255)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="0", [1 x [255 x [255 x i32]]]* noalias readonly "unpacked"="1", [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="2", [64 x [1 x [9 x [9 x i16]]]]* noalias readonly "unpacked"="3", [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="4", [64 x i10]* noalias nocapture readonly align 512 "unpacked"="5.0", [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="6", [64 x [255 x [255 x i32]]]* noalias readonly "unpacked"="7", [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="8", [32 x [64 x [1 x [1 x i32]]]]* noalias readonly "unpacked"="9", [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="10", [32 x i24]* noalias nocapture readonly align 512 "unpacked"="11.0", [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="12", [32 x [255 x [255 x i32]]]* noalias readonly "unpacked"="13", [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* noalias "unpacked"="14", [1 x [32 x [5 x [5 x i32]]]]* noalias readonly align 512 "unpacked"="15", [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="16", [1 x i15]* noalias nocapture readonly align 512 "unpacked"="17.0", [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* noalias "unpacked"="18", [1 x [255 x [255 x i32]]]* noalias readonly "unpacked"="19") unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a64a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %6, [64 x [255 x [255 x i32]]]* %7)
  call fastcc void @"onebyonecpy_hls.p0a32a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %12, [32 x [255 x [255 x i32]]]* %13)
  call fastcc void @"onebyonecpy_hls.p0a1a255a255struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"([1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %18, [1 x [255 x [255 x i32]]]* %19)
...
entry:
  ...
  %13 = bitcast i8* %malloccall2 to [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  ...
  %16 = bitcast i8* %malloccall4 to [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  ...
  %19 = bitcast i8* %malloccall5 to [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]*
  call void @copy_out([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* %10, [1 x [255 x [255 x i32]]]* %0, [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* %11, [64 x [1 x [9 x [9 x i16]]]]* %1, [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* %12, [64 x i10]* %2, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %13, [64 x [255 x [255 x i32]]]* %3, [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* %14, [32 x [64 x [1 x [1 x i32]]]]* %4, [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* %15, [32 x i24]* %5, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %16, [32 x [255 x [255 x i32]]]* %6, [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* %17, [1 x [32 x [5 x [5 x i32]]]]* %7, [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* %18, [1 x i15]* %8, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %19, [1 x [255 x [255 x i32]]]* %9)
  ...
  %23 = bitcast [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %13 to [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*
  ...
  %26 = bitcast [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %16 to [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*
  ...
  %29 = bitcast [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %19 to [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*
  call void @srcnn_hw_stub([255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]* %20, [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]* %21, %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"* %22, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %23, [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]* %24, %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"* %25, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %26, [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]* %27, %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"* %28, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]* %29)
  call void @copy_in([1 x [255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]]* %10, [1 x [255 x [255 x i32]]]* %0, [64 x [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]]* %11, [64 x [1 x [9 x [9 x i16]]]]* %1, [64 x %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"]* %12, [64 x i10]* %2, [64 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %13, [64 x [255 x [255 x i32]]]* %3, [32 x [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]]* %14, [32 x [64 x [1 x [1 x i32]]]]* %4, [32 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]* %15, [32 x i24]* %5, [32 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %16, [32 x [255 x [255 x i32]]]* %6, [1 x [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]]* %17, [1 x [32 x [5 x [5 x i32]]]]* %7, [1 x %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"]* %18, [1 x i15]* %8, [1 x [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]]* %19, [1 x [255 x [255 x i32]]]* %9)
  ret void
}

declare void @srcnn_hw_stub([255 x [255 x %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"]]*, [1 x [9 x [9 x %"struct.ap_fixed<12, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<10, 1, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*, [64 x [1 x [1 x %"struct.ap_fixed<18, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<24, 2, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*, [32 x [5 x [5 x %"struct.ap_fixed<20, 1, AP_TRN, AP_WRAP, 0>"]]]*, %"struct.ap_fixed<15, 1, AP_TRN, AP_WRAP, 0>"*, [255 x [255 x %"struct.ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>"]]*)
