...
declare void @apatb_srcnn_hw([1 x [255 x [255 x float]]]*, [64 x [1 x [9 x [9 x float]]]]*, [64 x float]*, [64 x [255 x [255 x float]]]*, [32 x [64 x [1 x [1 x float]]]]*, [32 x float]*, [32 x [255 x [255 x float]]]*, [1 x [32 x [5 x [5 x float]]]]*, [1 x float]*, [1 x [255 x [255 x float]]]*)
...
define void @srcnn_hw_stub_wrapper([1 x [255 x [255 x float]]]*, [64 x [1 x [9 x [9 x float]]]]*, [64 x float]*, [64 x [255 x [255 x float]]]*, [32 x [64 x [1 x [1 x float]]]]*, [32 x float]*, [32 x [255 x [255 x float]]]*, [1 x [32 x [5 x [5 x float]]]]*, [1 x float]*, [1 x [255 x [255 x float]]]*) #5 {
entry:
  ...
  call void @srcnn_hw_stub([255 x [255 x float]]* %10, [1 x [9 x [9 x float]]]* %11, float* %12, [255 x [255 x float]]* %13, [64 x [1 x [1 x float]]]* %14, float* %15, [255 x [255 x float]]* %16, [32 x [5 x [5 x float]]]* %17, float* %18, [255 x [255 x float]]* %19)
...
declare void @srcnn_hw_stub([255 x [255 x float]]*, [1 x [9 x [9 x float]]]*, float*, [255 x [255 x float]]*, [64 x [1 x [1 x float]]]*, float*, [255 x [255 x float]]*, [32 x [5 x [5 x float]]]*, float*, [255 x [255 x float]]*)
