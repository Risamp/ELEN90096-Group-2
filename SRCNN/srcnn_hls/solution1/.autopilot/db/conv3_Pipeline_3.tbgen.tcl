set moduleName conv3_Pipeline_3
set isTopModule 0
...
set C_modelName {conv3_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_fm_buffer_0 float 32 regular {array 289 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ output_fm_buffer_0_address0 sc_out sc_lv 9 signal 0 } 
...
set Spec2ImplPortList { 
	output_fm_buffer_0 { ap_memory {  { output_fm_buffer_0_address0 mem_address 1 9 }  { output_fm_buffer_0_ce0 mem_ce 1 1 }  { output_fm_buffer_0_we0 mem_we 1 1 }  { output_fm_buffer_0_d0 mem_din 1 32 } } }
}
