		   ...
		   output_conv3 output_ftmap[N3][H][W])
{
	...
	memset(conv1_output_ftmap, 0, N1 * H * W * sizeof(output_conv1));
	memset(conv2_output_ftmap, 0, N2 * H * W * sizeof(output_conv2));
	memset(output_ftmap, 0, N3 * H * W * sizeof(output_conv3));
