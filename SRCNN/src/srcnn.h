...
typedef ap_fixed<32,3> test;  // test parameter
...
void export_buffer_tile_c1(test output_fm_buffer[N1][TH][TW],
						   test output_ftmap[N1][H][W],
                           int tx0,
                           int ty0,
						   conv1_b conv1_biases[N1]
...
void load_buffer_tile_c2(test input_fm_buffer[N1][TH + (2 * P2)][TW + (2 * P2)],
						 test input_fm[N1][H][W],
                         int tx0,
                         int ty0);

void export_buffer_tile_c2(test output_fm_buffer[N2][TH][TW],
						   test output_ftmap[N2][H][W],
                           int tx0,
                           int ty0,
						   conv2_b conv2_biases[N2]);

void load_buffer_tile_c3(test input_fm_buffer[N2][TH + (2 * P3)][TW + (2 * P3)],
