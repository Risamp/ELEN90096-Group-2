...
reg   [31:0] bundle_2_addr_3_read_reg_660;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter11 == 1'b1) & (m_axi_bundle_2_RVALID == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state3_io)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter11 == 1'b1) & (m_axi_bundle_2_RVALID == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state3_io)));
end
...
always @ (*) begin
    ap_block_state12_pp0_stage0_iter11 = (m_axi_bundle_2_RVALID == 1'b0);
end
...
always @ (*) begin
    ap_block_state3_io = ((m_axi_bundle_2_ARREADY == 1'b0) & (ap_predicate_op77_readreq_state3 == 1'b1));
end
...
assign empty_340_fu_551_p1 = bundle_2_addr_3_read_reg_660;
...
assign m_axi_bundle_2_ARADDR = sext_ln79_1_fu_451_p1;
