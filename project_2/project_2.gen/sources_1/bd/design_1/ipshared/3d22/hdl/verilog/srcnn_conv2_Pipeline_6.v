...
reg   [7:0] phi_urem1075_fu_102;
wire   [7:0] idx_urem1077_fu_442_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul1073_fu_106;
wire   [16:0] next_mul1074_fu_372_p2;
reg   [16:0] ap_sig_allocacmp_phi_mul1073_load;
reg   [7:0] loop_index_1_i_fu_110;
wire   [7:0] empty_fu_363_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_1_i_load;
wire   [4:0] tmp_fu_378_p4;
wire   [7:0] tmp_154_fu_388_p1;
wire   [7:0] empty_215_fu_392_p2;
wire   [7:0] next_urem1076_fu_430_p2;
wire   [0:0] empty_214_fu_436_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond4513_fu_357_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            phi_mul1073_fu_106 <= next_mul1074_fu_372_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            phi_mul1073_fu_106 <= 17'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            phi_urem1075_fu_102 <= 8'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            phi_urem1075_fu_102 <= idx_urem1077_fu_442_p3;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_phi_mul1073_load = 17'd0;
    end else begin
        ap_sig_allocacmp_phi_mul1073_load = phi_mul1073_fu_106;
    end
end
...
assign empty_214_fu_436_p2 = ((next_urem1076_fu_430_p2 < 8'd15) ? 1'b1 : 1'b0);

assign empty_215_fu_392_p2 = (add_ln113_6 + tmp_154_fu_388_p1);
...
assign idx_urem1077_fu_442_p3 = ((empty_214_fu_436_p2[0:0] == 1'b1) ? next_urem1076_fu_430_p2 : 8'd0);
...
assign next_mul1074_fu_372_p2 = (ap_sig_allocacmp_phi_mul1073_load + 17'd274);

assign next_urem1076_fu_430_p2 = (phi_urem1075_fu_102 + 8'd1);
...
assign p_cast_fu_398_p1 = empty_215_fu_392_p2;

assign tmp_154_fu_388_p1 = tmp_fu_378_p4;

assign tmp_65_fu_454_p16 = phi_urem1075_fu_102[3:0];

assign tmp_fu_378_p4 = {{ap_sig_allocacmp_phi_mul1073_load[16:12]}};
