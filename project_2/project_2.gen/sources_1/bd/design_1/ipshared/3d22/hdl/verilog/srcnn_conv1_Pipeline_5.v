...
wire   [0:0] exitcond105624_fu_177_p2;
...
wire   [15:0] tmp_148_fu_262_p5;
reg   [15:0] tmp_148_reg_324;
wire   [63:0] p_cast_fu_218_p1;
wire    ap_block_pp0_stage0_01001;
reg   [7:0] phi_urem3201_fu_78;
wire   [7:0] idx_urem3203_fu_250_p3;
wire    ap_loop_init;
reg   [16:0] phi_mul3199_fu_82;
wire   [16:0] next_mul3200_fu_192_p2;
reg   [16:0] ap_sig_allocacmp_phi_mul3199_load;
reg   [7:0] loop_index_1_i980_fu_86;
wire   [7:0] empty_fu_183_p2;
reg   [7:0] ap_sig_allocacmp_loop_index_1_i980_load;
wire   [6:0] tmp_fu_198_p4;
wire   [13:0] tmp_413_cast_fu_208_p1;
wire   [13:0] empty_401_fu_212_p2;
wire   [7:0] next_urem3202_fu_238_p2;
wire   [0:0] empty_400_fu_244_p2;
wire   [1:0] tmp_148_fu_262_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond105624_fu_177_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_1_i980_fu_86 <= empty_fu_183_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_1_i980_fu_86 <= 8'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond105624_fu_177_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index_1_i980_load = 8'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_mul3199_load = 17'd0;
    end else begin
...
assign empty_400_fu_244_p2 = ((next_urem3202_fu_238_p2 < 8'd3) ? 1'b1 : 1'b0);

assign empty_401_fu_212_p2 = (mul_ln140_1 + tmp_413_cast_fu_208_p1);

assign empty_fu_183_p2 = (ap_sig_allocacmp_loop_index_1_i980_load + 8'd1);

assign exitcond105624_fu_177_p2 = ((ap_sig_allocacmp_loop_index_1_i980_load == 8'd255) ? 1'b1 : 1'b0);

assign idx_urem3203_fu_250_p3 = ((empty_400_fu_244_p2[0:0] == 1'b1) ? next_urem3202_fu_238_p2 : 8'd0);
...
assign m_axi_bundle_2_WDATA = tmp_148_reg_324;
...
assign next_mul3200_fu_192_p2 = (ap_sig_allocacmp_phi_mul3199_load + 17'd342);

assign next_urem3202_fu_238_p2 = (phi_urem3201_fu_78 + 8'd1);

assign p_cast_fu_218_p1 = empty_401_fu_212_p2;

assign tmp_148_fu_262_p4 = phi_urem3201_fu_78[1:0];

assign tmp_413_cast_fu_208_p1 = tmp_fu_198_p4;

assign tmp_fu_198_p4 = {{ap_sig_allocacmp_phi_mul3199_load[16:10]}};
