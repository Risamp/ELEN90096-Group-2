...
reg   [15:0] weights_addr_read_reg_246;
wire   [63:0] p_cast13_fu_195_p1;
reg   [6:0] loop_index_i_fu_64;
wire   [6:0] empty_213_fu_200_p2;
wire    ap_loop_init;
reg   [2:0] bout_fu_68;
...
wire   [0:0] exitcond41047_fu_157_p2;
wire   [2:0] add_ln91_fu_151_p2;
wire   [6:0] select_ln91_fu_163_p3;
wire   [1:0] empty_212_fu_183_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            loop_index_i_fu_64 <= empty_213_fu_200_p2;
        end
    end
end
...
assign empty_212_fu_183_p1 = select_ln91_1_fu_171_p3[1:0];

assign empty_213_fu_200_p2 = (select_ln91_fu_163_p3 + 7'd1);

assign empty_fu_179_p1 = select_ln91_fu_163_p3[5:0];

assign exitcond41047_fu_157_p2 = ((loop_index_i_fu_64 == 7'd64) ? 1'b1 : 1'b0);
...
assign select_ln91_1_fu_171_p3 = ((exitcond41047_fu_157_p2[0:0] == 1'b1) ? add_ln91_fu_151_p2 : bout_fu_68);

assign select_ln91_fu_163_p3 = ((exitcond41047_fu_157_p2[0:0] == 1'b1) ? 7'd0 : loop_index_i_fu_64);

assign tmp_s_fu_187_p3 = {{empty_212_fu_183_p1}, {empty_fu_179_p1}};
