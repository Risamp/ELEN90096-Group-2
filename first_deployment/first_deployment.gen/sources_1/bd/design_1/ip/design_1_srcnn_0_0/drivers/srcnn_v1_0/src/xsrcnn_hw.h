...
#define XSRCNN_CONTROL_ADDR_AP_CTRL                 0x00
#define XSRCNN_CONTROL_ADDR_GIE                     0x04
#define XSRCNN_CONTROL_ADDR_IER                     0x08
#define XSRCNN_CONTROL_ADDR_ISR                     0x0c
#define XSRCNN_CONTROL_ADDR_INPUT_FTMAP_DATA        0x10
#define XSRCNN_CONTROL_BITS_INPUT_FTMAP_DATA        64
#define XSRCNN_CONTROL_ADDR_CONV1_WEIGHTS_DATA      0x1c
#define XSRCNN_CONTROL_BITS_CONV1_WEIGHTS_DATA      64
#define XSRCNN_CONTROL_ADDR_CONV1_BIASES_DATA       0x28
#define XSRCNN_CONTROL_BITS_CONV1_BIASES_DATA       64
#define XSRCNN_CONTROL_ADDR_CONV1_OUTPUT_FTMAP_DATA 0x34
#define XSRCNN_CONTROL_BITS_CONV1_OUTPUT_FTMAP_DATA 64
#define XSRCNN_CONTROL_ADDR_CONV2_WEIGHTS_DATA      0x40
#define XSRCNN_CONTROL_BITS_CONV2_WEIGHTS_DATA      64
#define XSRCNN_CONTROL_ADDR_CONV2_BIASES_DATA       0x4c
#define XSRCNN_CONTROL_BITS_CONV2_BIASES_DATA       64
#define XSRCNN_CONTROL_ADDR_CONV2_OUTPUT_FTMAP_DATA 0x58
#define XSRCNN_CONTROL_BITS_CONV2_OUTPUT_FTMAP_DATA 64
#define XSRCNN_CONTROL_ADDR_CONV3_WEIGHTS_DATA      0x64
#define XSRCNN_CONTROL_BITS_CONV3_WEIGHTS_DATA      64
#define XSRCNN_CONTROL_ADDR_CONV3_BIASES_DATA       0x70
#define XSRCNN_CONTROL_BITS_CONV3_BIASES_DATA       64
#define XSRCNN_CONTROL_ADDR_OUTPUT_FTMAP_DATA       0x7c
#define XSRCNN_CONTROL_BITS_OUTPUT_FTMAP_DATA       64
