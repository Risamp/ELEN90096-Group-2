...
reg   [15:0] w3_addr_read_reg_412;
wire   [63:0] p_cast2_fu_323_p1;
reg   [2:0] loop_index_i_fu_74;
wire   [2:0] empty_241_fu_328_p2;
wire    ap_loop_init;
reg   [2:0] k_fu_78;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_w3_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_w3_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (m_axi_w3_RVALID == 1'b0);
end
...
assign empty_237_fu_285_p2 = (empty_fu_229_p2 + select_ln120_1_cast_fu_281_p1);

assign empty_238_fu_295_p1 = empty_237_fu_285_p2[7:0];

assign empty_239_fu_307_p2 = (p_shl_fu_299_p3 + p_cast_fu_291_p1);

assign empty_240_fu_317_p2 = (empty_239_fu_307_p2 + select_ln120_cast_fu_313_p1);

assign empty_241_fu_328_p2 = (select_ln120_fu_265_p3 + 3'd1);
...
assign p_cast2_fu_323_p1 = empty_240_fu_317_p2;

assign p_cast_fu_291_p1 = empty_237_fu_285_p2;

assign p_shl_fu_299_p3 = {{empty_238_fu_295_p1}, {2'd0}};
...
assign weight_buffer_0_d0 = w3_addr_read_reg_412;
