...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        phi_mul804_fu_86 <= 17'd0;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        phi_mul804_fu_86 <= add_ln110_1_fu_240_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        phi_urem806_fu_82 <= 8'd0;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        phi_urem806_fu_82 <= select_ln110_fu_323_p3;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_urem806_load_1 = 8'd0;
    end else begin
        ap_sig_allocacmp_phi_urem806_load_1 = phi_urem806_fu_82;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        grp_load_fu_177_p1 = phi_urem806_fu_82;
    end else if (((icmp_ln110_fu_206_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        grp_load_fu_177_p1 = ap_sig_allocacmp_phi_urem806_load_1;
    end else begin
...
assign add_ln110_1_fu_240_p2 = (phi_mul804_fu_86 + 17'd322);
...
assign select_ln115_fu_294_p3 = ((tmp_fu_286_p3[0:0] == 1'b1) ? 15'd0 : add_ln115_fu_281_p2);

assign sext_ln110_cast_fu_184_p1 = $signed(sext_ln110);

assign sext_ln113_cast_fu_180_p1 = $signed(sext_ln113);

assign tmp_56_fu_256_p6 = {{phi_mul804_fu_86[16:14]}};

assign tmp_fu_286_p3 = add_ln113_1_fu_276_p2[32'd15];

assign trunc_ln110_1_fu_246_p4 = {{phi_mul804_fu_86[16:14]}};

assign trunc_ln113_fu_272_p1 = tmp_56_fu_256_p7[14:0];
